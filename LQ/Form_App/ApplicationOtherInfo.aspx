<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationOtherInfo.aspx.cs" Inherits="LQ.Form_App.ApplicationOtherInfo" %>
        ...
        <table style="border-spacing: 0px; width: 100%; font-size: xx-small;">
            <tr style="vertical-align: top;">
                <td style="width: 200px;">
                    ...
                    <asp:Button ID="BT_QUESTIONFORM" runat="server" CssClass="ASPButton" Text="QUESTION FORM" Width="100%" OnClick="BT_QUESTIONFORM_Click" />
                    ...
                    <asp:Button ID="BT_PENDING" runat="server" CssClass="ASPButton" Text="PENDING PROCESS" BackColor="Yellow" ForeColor="Red" Width="100%" OnClick="BT_PENDING_Click" />
                    ...
                    <asp:Button ID="BT_REINSURANCE" runat="server" CssClass="ASPButton" Text="REINSURANCE" Width="100%" OnClick="BT_REINSURANCE_Click" />
                    <br />
                    <br />
                ...
                <td>
                            ...
                            <td>
                                <table style="border-spacing: 0px; width: 100%;">
                                    <tr style="vertical-align: top;">
                                        ...
                                        <td style="width: 70%;">
                                            <asp:DataGrid ID="DGR_ITEM" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" Font-Size="X-Small" GridLines="None" ItemStyle-Wrap="true" PageSize="20" ShowHeader="False" Width="95%" Enabled="False">
                                                <ItemStyle VerticalAlign="Top" />
                                                <Columns>
                            ...
                            <td>
                                <asp:DataGrid ID="DGR_CLAIM" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="Tahoma" Font-Size="XX-Small" GridLines="None" ItemStyle-Wrap="true" PageSize="20" Width="100%" ForeColor="#333333">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="CLAIM_DATE" HeaderText="DATE">
                                        ...
                                        <asp:BoundColumn DataField="ADDITION" HeaderText="ADDITION">
                                            <HeaderStyle HorizontalAlign="Right" Width="80" />
                                            <ItemStyle HorizontalAlign="Right" ForeColor="Blue" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="DEDUCTION" HeaderText="DEDUCTION">
                                            <HeaderStyle HorizontalAlign="Right" Width="80" />
                                            <ItemStyle HorizontalAlign="Right" ForeColor="Blue" />
                                        </asp:BoundColumn>
                                        ...
                                        <asp:BoundColumn DataField="CLAIM_TYPE_DESCR" HeaderText="DESCRIPTION">
                                            <ItemStyle ForeColor="Green" Wrap="true" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="CLAIM_STATUS" HeaderText="CLAIM_STATUS"></asp:BoundColumn>
                                    </Columns>
                                </asp:DataGrid>
                            </td>
                        </tr>
                    ...
                    <table id="TBL_QUESTIONFORM" runat="server" visible="false" style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td>
                                <iframe style="width: 99%; height: 90vh; overflow: auto;" src="ApplicationQuestionFrame.aspx?REGNO=<%=Request.QueryString["ID"]%>"></iframe>
                            </td>
                        </tr>
                    </table>

                    <table id="TBL_REINSURANCE" runat="server" visible="false" style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td>
                                <iframe style="width: 99%; height: 90vh; overflow: auto;" src="ApplicationReinsurance.aspx?REGNO=<%=Request.QueryString["ID"]%>"></iframe>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                                    ...
                                    CellSpacing="1" GridLines="Vertical" ItemStyle-Wrap="true" AutoGenerateColumns="False" CssClass="ASPDatagrid" Width="100%" OnItemDataBound="DGR_ItemDataBound" ShowFooter="True" Enabled="False">
                                    <SelectedItemStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
                                    <AlternatingItemStyle BackColor="#F7F7F7" />
                    ...
                    <table id="TBL_MEDICALDOC" runat="server" visible="false" style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td>
                                <iframe style="width: 99%; height: 90vh; overflow: auto;" src="ApplicationDocument.aspx?ID=<%=Request.QueryString["ID"]%>"></iframe>
                            </td>
                        </tr>
                    </table>

                    <table id="TBL_PENDING" runat="server" visible="false" style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td>
                                <iframe style="width: 99%; height: 90vh; overflow: auto;" src="ApplicationPendingFrame.aspx?REGNO=<%=Request.QueryString["ID"]%>"></iframe>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table id="TBL_EXCLUSION" runat="server" visible="false" style="border-spacing: 0px; width: 100%;">
                        ...
                        <tr style="vertical-align: top;">
                            <td>
                                <asp:DataGrid ID="DGR_ICD_EXCLUDED" runat="server" AutoGenerateColumns="False" CellPadding="1" Font-Names="Tahoma" Font-Size="X-Small" GridLines="None" ItemStyle-Wrap="true" PageSize="20" Width="100%" ForeColor="#333333" ShowHeader="False">
                                                            ...
                                                            <asp:DataGrid ID="DGR_ICD_BENEFIT" runat="server" AutoGenerateColumns="False" CellPadding="0" CellSpacing="0" Font-Names="Tahoma" Font-Size="XX-Small" GridLines="None" ItemStyle-Wrap="true" Width="100%" ForeColor="#333333" ShowHeader="False">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="CB" runat="server" Enabled="false" CssClass="ASPTextBox" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                </Columns>
                                                            </asp:DataGrid>
                                ...
                                <table style="border-spacing: 0px; width: 100%; font-size: xx-small; background-color: lightyellow;">
                                    <tr style="vertical-align: top;">
                                        ...
                                        <td>
                                            <asp:TextBox ID="TXT_JOB" runat="server" CssClass="ASPTextBox" Width="99%" TextMode="MultiLine" Height="30" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr style="vertical-align: top;">
                                        <td>EXCLUDED HOBBY</td>
                                        <td>
                                            <asp:TextBox ID="TXT_HOBBY" runat="server" CssClass="ASPTextBox" Width="99%" TextMode="MultiLine" Height="30" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
