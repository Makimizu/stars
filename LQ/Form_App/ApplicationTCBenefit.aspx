<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationTCBenefit.aspx.cs" Inherits="LQ.Form_App.ApplicationTCBenefit" %>
            ...
            <tr style="vertical-align: top;">
                ...
                <td>
                    ...
                    <table id="TBL_OTHERINFO" runat="server" style="border-spacing: 0px; width: 100%;" visible="false">
                        <tr>
                            <td>
                                <asp:DataGrid ID="DGR_ITEM" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="2" Font-Names="Tahoma" Font-Size="X-Small" GridLines="Horizontal" ItemStyle-Wrap="true" PageSize="20" ShowHeader="False" Width="100%">
                    ...
                    <table id="TBL_FUND" runat="server" style="border-spacing: 0px; width: 100%;" visible="false">
                        <tr>
                            <td>
                                <asp:DataGrid ID="DGR_FUND" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="Tahoma" Font-Size="X-Small" GridLines="None" ItemStyle-Wrap="true" PageSize="20" Width="100%" ForeColor="#333333">
