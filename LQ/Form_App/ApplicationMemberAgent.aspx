<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationMemberAgent.aspx.cs" Inherits="LQ.Form_App.ApplicationMemberAgent" %>
                            ...
                            <td>
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr style="vertical-align: top;">
                                        <td>ADDRESS</td>
                                        <td>
                                            <asp:TextBox ID="TXT_ADDRESS" runat="server" MaxLength="255" Width="90%" TextMode="MultiLine" Height="60px" CssClass="ASPTextBox" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>CITY</td>
                                        <td>
                                            <asp:TextBox ID="TXT_CITY" runat="server" MaxLength="50" Width="90%" Style="background-color: yellow" CssClass="ASPTextBox" Enabled="False"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>PROVINCE</td>
                                        <td>
                                            <asp:DropDownList ID="DDL_PROVINCE" runat="server" BackColor="Yellow" CssClass="ASPDropDownList" Enabled="False"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>COUNTRY</td>
                                        <td>
                                            <asp:DropDownList ID="DDL_COUNTRY" runat="server" BackColor="Yellow" CssClass="ASPDropDownList" Enabled="False"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>ZIP CODE</td>
                                        <td>
                                            <asp:TextBox ID="TXT_ZIPCODE" runat="server" MaxLength="10" Width="100px" Style="background-color: yellow" CssClass="ASPTextBox" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>PHONE 1</td>
                                        <td>
                                            <asp:TextBox ID="TXT_PHONE1" runat="server" MaxLength="50" Width="90%" Style="background-color: yellow" CssClass="ASPTextBox" Enabled="False"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>PHONE 2</td>
                                    ...
                                    <tr>
                                        <td>EMAIL</td>
                                        <td>
                                            <asp:TextBox ID="TXT_EMAIL" runat="server" MaxLength="100" Width="90%" Style="background-color: yellow" CssClass="ASPTextBox" Enabled="False"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>&nbsp;</td>
                            ...
                            <td>
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        <td>BANK NAME</td>
                                        <td>
                                            <asp:DropDownList ID="DDL_BANK" runat="server" CssClass="ASPDropDownList" Width="60%" Enabled="False">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
