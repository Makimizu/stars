<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationQuestion.aspx.cs" Inherits="LQ.Form_App.ApplicationQuestion" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table id="TBL_PARENT" runat="server" style="border-spacing: 0px; width: 100%; font-size: x-small;">
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DGR_QUESTION" runat="server" AutoGenerateColumns="False" CellPadding="3" Font-Names="Tahoma" Font-Size="8pt" GridLines="Horizontal" ItemStyle-Wrap="true" PageSize="20" ShowHeader="False" Width="100%" CssClass="ASPDatagrid" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" Enabled="False">
                        <PagerStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" HorizontalAlign="Right" Mode="NumericPages" />
                        <SelectedItemStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
                        <AlternatingItemStyle BackColor="#F7F7F7" />
                        <HeaderStyle BackColor="#4A3C8C" Font-Bold="True" ForeColor="#F7F7F7" />
                        <ItemStyle BackColor="#E7E7FF" VerticalAlign="Top" ForeColor="#4A3C8C" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" />
                        ...
                        <Columns>
                                                ...
                                                <table style="border-spacing: 0px; width: 100%;">
                                                    <tr style="vertical-align: top;">
                                                        ...
                                                        <td style="width: 200px;">
                                                            ...
                                                            <asp:TextBox ID="TXT_VAL" runat="server" CssClass="ASPTextBox" Visible="False" Width="95%" MaxLength="255"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td>
                                                <table style="border-spacing: 0px; width: 100%; border-top: inset;">
                                                    <tr style="vertical-align: top;">
                                                        ...
                                                        <td style="width: 200px;">
                                                            <asp:TextBox ID="TXT_NEXTVAL" runat="server" CssClass="ASPTextBox" Width="95%" MaxLength="255" Visible="false" BackColor="LightYellow" TextMode="MultiLine" Height="30"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="BT_Q" runat="server" CssClass="ASPButton" Text="?" ForeColor="White" CommandName="Child" Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
                            ...
                            <td>
                                ...
                                <asp:DataGrid ID="DGR_BUTTON" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" Font-Size="8pt" GridLines="None" ItemStyle-Wrap="true" PageSize="20" ShowHeader="False" Width="100%" CssClass="ASPDatagrid" OnItemCommand="DGR_BUTTON_ItemCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn>
                                            <ItemTemplate>
                                                <asp:Button ID="BT_MODULAR" runat="server" CssClass="ASPButton" Width="100%" CommandName="Modular" Style="white-space: normal;" />
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
                                </asp:DataGrid>
