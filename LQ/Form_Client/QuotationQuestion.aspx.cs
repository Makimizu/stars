...
{
    public partial class QuotationQuestion : System.Web.UI.Page
    {
        ...
        protected void LoadChildFrame()
        {
            if (LB_URL.Text.Trim().Length > 0)
            {
                TR_IF.Visible = true;
                IF.Src = LB_URL.Text + "&MEMBERID=" + DDL_MEMBER.SelectedValue;
            }
        }
        ...
        protected void TXT_NEXTVAL_TextChanged(object sender, EventArgs e)
        {
            SaveAll();
        }

        protected void DDL_REFF_SelectedIndexChanged1(object sender, EventArgs e)
        {
            SaveSubAll();
        }

        protected void TXT_VAL_TextChanged1(object sender, EventArgs e)
        {
            SaveSubAll();
        }

        protected void TXT_NEXTVAL_TextChanged1(object sender, EventArgs e)
        {
            SaveSubAll();
        }
    }
