<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationBenefit.aspx.cs" Inherits="LQ.Form_Client.QuotationBenefit" %>
        ...
        <table style="border-spacing: 0px; width: 100%;">
            <tr style="vertical-align: top;">
                ...
                <td>
                            ...
                            <td>
                                <asp:DataGrid ID="DGR_BENEFIT" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="ASPDatagrid" GridLines="Horizontal" ShowHeader="False" BorderColor="#CCCCCC">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="SQL_SUMINS" Visible="False"></asp:BoundColumn>
                                        <asp:TemplateColumn>
                                            <ItemTemplate>
                                                <table style="border-spacing: 0px; width: 100%; font-size: xx-small;">
                                                    <tr style="vertical-align: top;">
                                                            ...
                                                            <table style="border-spacing: 0px; width: 100%;">
                                                                ...
                                                                <tr id="TR_SUMINS" runat="server">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:DropDownList ID="DDL_SUMINS" runat="server" CssClass="ASPDropDownList" Visible="false"></asp:DropDownList>
                                                                    </td>
                                                                </tr>
                    ...
                    <table style="border-spacing: 0px; width: 100%; font-size: xx-small;" id="TBL_PAYOR" runat="server">
                        <tr>
                                                            ...
                                                            <table style="border-spacing: 0px; width: 100%;">
                                                                <tr>
                                                                    <td style="width: 130px;">
                                                                        <asp:Label ID="LB_MAX_PAYOR" runat="server"></asp:Label>
                                                                    </td>
                                                                    <td>
                    ...
                    <table style="border-spacing: 0px; width: 100%; font-size: xx-small;" id="TBL_HEALTH" runat="server">
                        <tr>
