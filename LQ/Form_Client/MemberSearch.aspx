<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberSearch.aspx.cs" Inherits="LQ.Form_Client.MemberSearch" %>
            ...
            <div class="col-xl-6 col-sm-6 mb-3">
                <div class="card text-dark bg-transparent o-hidden h-100" style="border-color: silver;">                    
                    <table style="border-spacing: 0px; width: 100%; font-size: x-small;">
                        <tr>
                            <td style="font-size: 20pt; width: 50px;">
                            ...
                            <td style="text-align: left; font-size: 12pt;">                                
                                <a href="#EXISTING" role="tab" data-toggle="tab">
                                    SEARCH EXISTING CUSTOMER&nbsp;:&nbsp;<asp:Label ID="LB_RESULT" runat="server" Font-Bold="true"></asp:Label>
                                </a>                                
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DDL_GENDER" runat="server" CssClass="ASPDropDownList" AutoPostBack="True" OnSelectedIndexChanged="DDL_GENDER_SelectedIndexChanged">
                                    <asp:ListItem Value="U">--UNDESCRIBED--</asp:ListItem>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <asp:Button ID="BT_SEARCH" runat="server" CssClass="ASPButton" Text="SEARCH" OnClick="BT_SEARCH_Click" Width="100px" OnClientClick="hourglass(); return true;" />
                            </td>
                        </tr>
                    </table>
                    <%--<a href="#EXISTING" role="tab" data-toggle="tab">
