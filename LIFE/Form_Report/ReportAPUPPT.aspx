<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportAPUPPT.aspx.cs" Inherits="LIFE.Form_Report.ReportAPUPPT" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="REGNO" HeaderText="NO REG"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="NAMA_PEMEGANG_POLIS" HeaderText="NAMA PEMEGANG POLIS"></asp:BoundColumn>
                            <asp:BoundColumn DataField="DOB_PEMEGANG_POLIS" HeaderText="DOB PEMEGANG POLIS"></asp:BoundColumn>
                            <asp:BoundColumn DataField="NAMA_PENERIMA_MANFAAT" HeaderText="NAMA PENERIMA MANFAAT"></asp:BoundColumn>
                            <asp:BoundColumn DataField="DOB_PENERIMA_MANFAAT" HeaderText="DOB PENERIMA MANFAAT"></asp:BoundColumn>
                            <asp:BoundColumn DataField="NAMA_PENERIMA_HIBAH" HeaderText="NAMA PENERIMA HIBAH"></asp:BoundColumn>
                            <asp:BoundColumn DataField="DOB_PENERIMA_HIBAH" HeaderText="DOB PENERIMA HIBAH"></asp:BoundColumn>
                            <asp:BoundColumn DataField="NAMA_PRODUK" HeaderText="PRODUK"></asp:BoundColumn>
                            <asp:BoundColumn DataField="JUMLAH_PREMI" HeaderText="PREMI"></asp:BoundColumn>
                            <asp:BoundColumn DataField="JUMLAH_TERTANGGUNG" HeaderText="TERTANGGUNG"></asp:BoundColumn>
                            <asp:BoundColumn DataField="CARA_BAYAR" HeaderText="CARA BAYAR"></asp:BoundColumn>
                            <asp:BoundColumn DataField="TOPUP_IREGULER" HeaderText="TOPUP IREGULER"></asp:BoundColumn>
                            <asp:BoundColumn DataField="TOPUP_REGULER" HeaderText="TOPUP REGULER"></asp:BoundColumn>
                            <asp:BoundColumn DataField="CHANNEL_DISTRIBUSI" HeaderText="CHANNEL DISTRIBUSI"></asp:BoundColumn>
                            <asp:BoundColumn DataField="NAMA_AGENT" HeaderText="NAMA AGENT"></asp:BoundColumn>
                            <asp:BoundColumn DataField="STATUS_POLIS" HeaderText="STATUS POLIS"></asp:BoundColumn>
                            <asp:BoundColumn DataField="TANGGAL_INFORCE" HeaderText="TANGGAL INFORCE"></asp:BoundColumn>
                            <asp:BoundColumn DataField="TERKENA_SANKSI" HeaderText="TERKENA SANKSI"></asp:BoundColumn>
                            <asp:BoundColumn DataField="BERESIKO_TINGGI" HeaderText="RESIKO TINGGI"></asp:BoundColumn>
                        </Columns>
