...
namespace LIFE.Form_Report
{
    public partial class ReportAPUPPT : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            ...
            conn.QueryString = "EXEC [LIFE].[dbo].[SP_APU_PPT] '" + nama + "', '" + produk + "', '" + regno + "', '" + group + "', '" + start + "', '" + end + "', '" + track + "'";
            conn.ExecuteQuery(150000);
        ...
        protected void BT_EXCEL_Click(object sender, EventArgs e)
        {
            ...
            string filename = "report_apuppt_individu_" + unixTime.ToString();
