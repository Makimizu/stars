    ...
    public partial class ApplicationBenefit : System.Web.UI.Page
    {
        ...
        protected void FillDGRBenefit()
        {
            ...
            for (int i = 0; i < DGR_BENEFIT.Items.Count; i++)
            {
                ...
                Label lbRATE = (Label)DGR_BENEFIT.Items[i].FindControl("LB_RATE");
                Label lbPREMIUM = (Label)DGR_BENEFIT.Items[i].FindControl("LB_PREMIUM");
                ...
                lbRATE.Text = DGR_BENEFIT.Items[i].Cells[4].Text.Replace("&nbsp;", "");
                ...
                lbPREMIUM.Text = DGR_BENEFIT.Items[i].Cells[12].Text.Replace("&nbsp;", "");
