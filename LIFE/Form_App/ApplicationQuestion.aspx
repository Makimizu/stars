<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationQuestion.aspx.cs" Inherits="LIFE.Form_App.ApplicationQuestion" %>
        ...
        <table id="TBL_PARENT" runat="server" style="border-spacing: 0px; width: 100%; font-size: x-small;">
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="BT_SAVE" runat="server" CssClass="ASPButton" Text="SAVE" Width="150" OnClick="BT_SAVE_Click" />
                </td>
            </tr>
        </table>
                                ...
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            <asp:Button ID="BT_SAVE_SUB" runat="server" CssClass="ASPButton" Text="SAVE" Width="100" OnClick="BT_SAVE_SUB_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
