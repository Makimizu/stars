<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationPolicyTracking.aspx.cs" Inherits="LIFE.Form_App.ApplicationPolicyTracking" %>
            ...
            <tr>
                <td>
                    <table style="border-spacing: 0px; width: 100%; font-size: xx-small;">
                        ...
                        <tr>
                            <td>TEMPLATE UPLOAD</td>
                            <td>
                                <a href="Template_Upload_Policy_Track.xls">DOWNLOAD FILE</a>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
