<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppPending.aspx.cs" Inherits="LIFE.Form_App.AppPending" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDL_STAT" runat="server" CssClass="ASPDropDownList">
                                                <asp:ListItem Value="a.CLOSINGBY is null">OPEN</asp:ListItem>
                                                <asp:ListItem Value="a.CLOSINGBY is not null">STOP</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
