<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationOtherInfo.aspx.cs" Inherits="LIFE.Form_App.ApplicationOtherInfo" %>
                        ...
                        <tr style="vertical-align: top;">
                            ...
                            <td>
                                ...
                                <table style="border-spacing: 0px; width: 100%; font-size: xx-small; background-color: lightyellow;">
                                    ...
                                    <tr style="vertical-align: top;">
                                        <td>EXCLUDED DISEASE</td>
                                        <td>
                                            <asp:TextBox ID="TXT_DISEASE" runat="server" CssClass="ASPTextBox" Width="99%" TextMode="MultiLine" Height="30"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
