<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationBenefitSeries.aspx.cs" Inherits="LIFE.Form_App.ApplicationBenefitSeries" %>
                    ...
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr style="vertical-align: top;">
                            ...
                            <td>
                                ...
                                <asp:Button ID="BT_UPLOAD" runat="server" CssClass="ASPButton" Text="UPLOAD TIMELINE" ForeColor="White" BackColor="Orange" OnClick="BT_UPLOAD_Click" />
                                <asp:Label ID="LB_ERR" runat="server" ForeColor="Red"></asp:Label>
                            </td>
                            <td style="text-align: right;">
                                <asp:Button ID="BT_DEFAULT" runat="server" CssClass="ASPButton" Text="GENERATE TIMELINE" ForeColor="White" BackColor="Blue" OnClick="BT_DEFAULT_Click" /></td>
                    </table>
                </td>
            </tr>
            <tr>
