<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationReinsurance.aspx.cs" Inherits="LIFE.Form_App.ApplicationReinsurance" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="border-spacing: 0px; width: 98%;">
            <tr>
                <td>
                    <asp:DataGrid ID="DGR" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="ASPDatagrid" GridLines="None" CellPadding="4" ForeColor="#333333">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="SUMINS" HeaderText="ORIGIN SUM INSURED">
