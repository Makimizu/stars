<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppNewList.aspx.cs" Inherits="LIFE.Form_App.AppNewList" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDL_PREMIUM" runat="server" CssClass="ASPDropDownList">
                                                ...
                                                <asp:ListItem Value="and PREMIUM_STAT=1 ">SUB STANDARD</asp:ListItem>
                                                <asp:ListItem Value="and PREMIUM_STAT=0 ">STANDARD</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDL_MODE" runat="server" CssClass="ASPDropDownList">
                                                <asp:ListItem></asp:ListItem>
                                                <asp:ListItem Value="and bb.REGNO is null ">NEW</asp:ListItem>
                                                <asp:ListItem Value="and bb.REGNO is not null and b.REGNO is not null ">PENDING START</asp:ListItem>
                                                <asp:ListItem Value="and bb.REGNO is not null and b.REGNO is null ">PENDING DONE</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="FULLNAME" HeaderText="POLICY HOLDER<BR><table style='width:100%;'><tr><td>DOB<td/><td style='text-align:right;'>GENDER</td></tr></table>"></asp:BoundColumn>
                            <asp:BoundColumn DataField="PRODUCT" HeaderText="PRODUCT NAME<BR>PRODUCT GROUP"></asp:BoundColumn>
                            <asp:BoundColumn DataField="UW_CODE" HeaderText="U/W<BR>CODE">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="MODE" HeaderText="NEW/<BR>PENDING">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="PERIOD" HeaderText="START DATE<BR>END DATE">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="AGING" HeaderText="AGING<BR>(days)">
