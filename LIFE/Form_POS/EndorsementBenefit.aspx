<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndorsementBenefit.aspx.cs" Inherits="LIFE.Form_POS.EndorsementBenefit" %>
                    ...
                    <table style="border-spacing: 0px; width: 100%;">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:DataGrid ID="DGR_BENEFIT_CASHPLAN" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="ASPDatagrid" GridLines="Horizontal" ShowHeader="False" BorderColor="#CCCCCC">
                                    <ItemStyle Wrap="True" VerticalAlign="Top" Font-Size="XX-Small" />
                                    <Columns>
                                        <asp:BoundColumn DataField="TC_ID" Visible="False"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="BENEFIT_CODE" Visible="False"></asp:BoundColumn>
                                            ...
                                            <ItemTemplate>
                                                <table style="border-spacing: 0px; width: 100%; font-size: xx-small;">
                                                    <tr style="vertical-align: top;">
                                                        ...
                                                        <td style="width: 70%;">
                                                            <asp:DropDownList ID="DDL_PLAN" runat="server" CssClass="ASPDropDownList" Style="text-align: right;"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
