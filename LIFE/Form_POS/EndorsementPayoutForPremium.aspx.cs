...
{
    public partial class EndorsementPayoutForPremium : System.Web.UI.Page
    {
        ...
        {
            conn.QueryString = "exec SP_APPLICATION_ENDORSEMENT_PAYOUT_FOR_PREMIUM " +
                                "'" + LB_REGNO.Text + "'," +
                                "'" + LB_SEQ.Text + "'," +
                                "'" + LB_TYPE.Text + "'";
            conn.ExecuteQuery(150000);
        ...
        protected void DGR_LIST_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                conn.QueryString = "exec SP_APPLICATION_ENDORSEMENT_PAYOUT_FOR_PREMIUM_DELETE " +
                                    "'" + LB_REGNO.Text + "'," +
                                    LB_SEQ.Text + "," +
                                    "'" + LB_TYPE.Text + "'," +
                                    "'" + e.Item.Cells[0].Text + "'";
        ...
        protected void DGR_SEARCH_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                try
                {
                    conn.QueryString = "exec SP_APPLICATION_ENDORSEMENT_PAYOUT_FOR_PREMIUM_INSERT " +
                                        "'" + LB_REGNO.Text + "'," +
                                        "'" + LB_SEQ.Text + "'," +
                                        "'" + LB_TYPE.Text + "'," +
                                        "'" + e.Item.Cells[0].Text + "'," +
        ...
        protected void DGR_SEARCH_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            DGR_SEARCH.CurrentPageIndex = e.NewPageIndex;
            FillDGRSearch();
        }
        ...
        protected void DGR_SEARCH_PTIR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                try
                {
                    conn.QueryString = "exec SP_APPLICATION_ENDORSEMENT_PAYOUT_FOR_PREMIUM_PTIR_INSERT " +
                                        "'" + LB_REGNO.Text + "'," +
                                        "'" + LB_SEQ.Text + "'," +
                                        "'" + LB_TYPE.Text + "'," +
                                        "'" + e.Item.Cells[0].Text + "'," +
