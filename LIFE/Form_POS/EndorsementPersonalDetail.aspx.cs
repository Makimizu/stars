...
{
    public partial class EndorsementPersonalDetail : System.Web.UI.Page
    {
        ...
        protected void LoadMember(string ID)
            ...
            conn.QueryString = "EXEC SP_APPLICATION_ENDORSEMENT_QUOT_MEMBER_DETAIL '" + LB_REGNO.Text + "', '" + LB_SEQ.Text + "', '" + ID + "', '" + LB_MEMBER_TYPE.Text + "'";
            conn.ExecuteQuery();
        ...
        protected void Save()
        {
            ...
            try
            {
                conn.QueryString = "exec SP_APPLICATION_ENDORSEMENT_MEMBER_DETAIL_UPSERT " +
                                    "'" + LB_REGNO.Text + "'," +
                                    LB_SEQ.Text + "," +
                                    "'" + LB_TYPE.Text + "'," +
                                    ID + "," +
                ...
                Response.Redirect("EndorsementPersonalDetail.aspx?REGNO=" + LB_REGNO.Text + "&SEQ=" + LB_SEQ.Text + "&TYPE=" + LB_TYPE.Text + "&ID=" + ID + "&MEMBER_TYPE=" + LB_MEMBER_TYPE.Text, false);
            }
