<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndorsementPending007.aspx.cs" Inherits="LIFE.Form_POS.EndorsementPending007" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="LB_TYPE" runat="server" Visible="false" Text="007"></asp:Label>
        <table style="border-spacing: 0px; width: 100%;">
                    ...
                    <table id="TBL_REMARK" runat="server" style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td style="width: 120px;">
                                <asp:Button ID="BT_EMAIL" runat="server" CssClass="ASPButton" Text="SEND EMAIL TO" Width="100%" OnClientClick="showPrompt()" OnClick="BT_EMAIL_Click" />
                            </td>
                            <td>
            ...
            <tr>
                <td bgcolor="#CCCCCC" style="border-style: outset; text-align: center" colspan="2">
                    <asp:Label ID="LB_TITLE_MEDICAL_EXAM" runat="server" Text="MEDICAL EXAM"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <table id="TBL_MEDICAL_EXAM" runat="server" style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td style="width: 150px;">
                                MEDICAL EXAM COST :
                            </td>
                            <td>
                                <asp:DropDownList ID="DDL_MEDICAL_EXAM" runat="server" CssClass="ASPDropDownList"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <asp:Button ID="BT_MEDICAL_EXAM" runat="server" Text="SAVE" CssClass="ASPButton" OnClick="BT_MEDICAL_EXAM_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
