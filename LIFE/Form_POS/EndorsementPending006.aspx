<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndorsementPending006.aspx.cs" Inherits="LIFE.Form_POS.EndorsementPending006" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="LB_TYPE" runat="server" Visible="false" Text="006"></asp:Label>
        <table style="border-spacing: 0px; width: 100%;">
            ...
            <tr>
                <td>
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td bgcolor="#CCCCCC" style="border-style: outset; text-align: center; width: 50%;">UNSELECTED ISSUES
                            </td>
                            <td bgcolor="#CCCCCC" style="border-style: outset; text-align: center; width: 50%;">SELECTED ISSUES
                            </td>
                        </tr>
                        <tr style="vertical-align: top;">
                            <td>
