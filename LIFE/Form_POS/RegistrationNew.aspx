<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationNew.aspx.cs" Inherits="LIFE.Form_POS.RegistrationNew" %>
                                                    ...
                                                    <td style="width: 50%;">
                                                        <table style="border-spacing: 0px; width: 100%;">
                                                            ...
                                                            <tr>
                                                                <td>POLICY STATUS</td>
                                                                <td>
                                                                    <asp:DropDownList ID="DDL_STATUS" runat="server" CssClass="ASPDropDownList"></asp:DropDownList></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td style="width: 50%;">
