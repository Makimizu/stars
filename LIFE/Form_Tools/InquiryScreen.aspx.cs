...
namespace LIFE.Form_Tools
{
    public partial class InquiryScreen : System.Web.UI.Page
    {
        ...
        protected void Setup()
        {
            ...
            {
                BT_NEW.Visible = true;
                LB_NEW.Text = conn.GetFieldValue("URL_SCREEN_NEW").ToString() + "&readonly=";
            }
        }
        ...
        protected void FillDGR()
        {
            ...
            {
                DGR.Items[i].Cells[0].Text = "<a href='" + URL + DGR.Items[i].Cells[0].Text + ReadOnly + "'>" + DGR.Items[i].Cells[0].Text + "</a>";
            }
        }
