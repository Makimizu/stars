<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimBenefitICD.aspx.cs" Inherits="LIFE.Form_Claim.ClaimBenefitICD" %>
                ...
                <td>
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr id="TR_UNSELECTED" runat="server">
                            <td>
                                <asp:TextBox ID="TXT_ICDSEARCH" runat="server" Width="95%" CssClass="ASPTextBox" placeholder="Search for ICD code or name ..." AutoPostBack="True" OnTextChanged="TXT_ICDSEARCH_TextChanged"></asp:TextBox>
