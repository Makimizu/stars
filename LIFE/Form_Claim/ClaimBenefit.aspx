<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimBenefit.aspx.cs" Inherits="LIFE.Form_Claim.ClaimBenefit" MaintainScrollPositionOnPostback="true" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Class/Global.js?ver=20221205"></script>
</head>
<body>
    <form id="form1" runat="server">
                        ...
                        <tr>
                            <td>
                                <asp:DataGrid ID="DGR_BENEFIT" runat="server" BackColor="White"
                                    ...
                                    OnItemCommand="DGR_BENEFIT_ItemCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="">
                                            ...
                                            <ItemStyle HorizontalAlign="Right" />
                                            <ItemTemplate>
                                                <asp:Button ID="BT_OPEN_INFO" runat="server" Visible="false" CommandName="OpenInfo" CssClass="ASPButton" BackColor="Green" ForeColor="White" Text="OP" Font-Bold="True"/>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
                                </asp:DataGrid>
                                ...
                                <asp:DataGrid ID="DGR_BENEFIT_PAYOR" runat="server" BackColor="White"
                                    BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                    CellSpacing="1" GridLines="Vertical" ItemStyle-Wrap="true" AutoGenerateColumns="False" Width="100%" CssClass="ASPDatagrid" ShowHeader="False">
                                    <SelectedItemStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
                                    <AlternatingItemStyle BackColor="#F7F7F7" />
                                    <ItemStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" Wrap="True" VerticalAlign="Top" />
                                    <HeaderStyle BackColor="#4A3C8C" ForeColor="#F7F7F7" />
        ...
        <div style="background-color: white !important; opacity: 1;">
            <asp:Panel ID="FlagPopup" runat="server" BackColor="White" Height="120px" Width="60%" Style="z-index: 2; background-color: White; position: fixed; left: 100px; top: 12%; border: outset 2px gray; padding: 5px; display:none;">
                <asp:Label ID="LB_BENEFIT_CODE" runat="server" Visible="false"></asp:Label>
                <asp:Label ID="LB_INSURED_MEMBER_ID" runat="server" Visible="false"></asp:Label>
                <asp:TextBox ID="TXT_CALCULATED_AMT" runat="server" Visible="false" Width="50px"></asp:TextBox>
                <table style="border-spacing: 0px; width: 100%;">
                    <tr>
                        <td>
                             <table style="border-spacing: 0px; width: 100%; height: 30px;">
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Font-Bold="True" Font-Size="Small">INCURRED INFORMATION</asp:Label>
                                    </td>
                                    <td style="text-align: right;">
                        ...
                        <td>
                            <table style="border-spacing: 0px; width: 100%; background-color: #E7E7FF;">
                                <tr>
                                    <td>INCURRED DATE</td>
                                    <td>
                                        <asp:TextBox ID="TXT_INCDATE1" onchange="calculateDateDiff()" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="ceDate1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_INCDATE1">
                                        </ajaxToolkit:CalendarExtender>
                                        &nbsp;-&nbsp;
                                        <asp:TextBox ID="TXT_INCDATE2" onchange="calculateDateDiff()" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_INCDATE2">
                                        </ajaxToolkit:CalendarExtender>
                                    </td>
                                </tr>
                                <tr>
                                    <td>TOTAL DAY</td>
                                    <td>
                                        <asp:TextBox ID="TXT_TOTAL_DAY" runat="server" CssClass="ASPTextBox" Width="50px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <asp:Button ID="BT_SAVE_INC" runat="server" CssClass="ASPButton" Text="SAVE" Width="100px" BackColor="Blue" ForeColor="White" OnClick="BT_INC_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<script type="text/javascript">
    function calculateDateDiff() {
        var startDate = parseDate(document.getElementById("TXT_INCDATE1").value);
        var endDate = parseDate(document.getElementById("TXT_INCDATE2").value);
        var diffMs = endDate - startDate;

        var diffDays = Math.floor(diffMs / (1000 * 60 * 60 * 24)) + 1;

        if (isNaN(diffDays)) {
            diffDays = 0; // default fallback
        }

        document.getElementById("TXT_TOTAL_DAY").value = diffDays;
    }
