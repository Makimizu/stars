...
{
    public partial class ClaimInquiry : System.Web.UI.Page
    {
        ...
        {
            conn.QueryString = "select SEQ, DESCR from PARAM_TRACK where TIPE_CODE = 'CLM' order by SEQ";
            conn.ExecuteQuery();
        ...
        protected void FillDGR()
        {
            ...
            conn.QueryString = "select " +
                                ...
                                "inner join PARAM_TRACK c on c.TIPE_CODE = 'CLM' and c.SEQ = a.LAST_TRACK " +
                                "where " +
                                "1=1 " + where + " " +
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                string url = "../../ReportViewer/Viewer.aspx?APPID=LF&CODE=24&REGNO=" + e.Item.Cells[1].Text + "&SEQ=" + e.Item.Cells[2].Text;
                ClientScript.RegisterStartupScript(GetType(), "", "<script language='javascript'>window.open('"+url+"','_blank','toolbar=no,scrollbars=no, resizable=yes,top=500, left=500, width=520, height=640')</script>");
            }
        }
