<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimNew.aspx.cs" Inherits="LIFE.Form_Claim.ClaimNew" %>
                            ...
                            <td style="width: 50%;">
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDL_SAVING" runat="server" CssClass="ASPDropDownList">
                                                <asp:ListItem></asp:ListItem>
                                                <asp:ListItem Value="and isnull(dbo.UFN_REGNO_BALANCE(a.REGNO), 0) > 0 ">> 0</asp:ListItem>
                                                <asp:ListItem Value="and isnull(dbo.UFN_REGNO_BALANCE(a.REGNO), 0) = 0 ">= 0</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="MEMBER" HeaderText="POLICY HOLDER"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="SAVING_BALANCE" HeaderText="SAVING<BR>BALANCE">
                                <HeaderStyle HorizontalAlign="Right" />
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:Button ID="BT_CLAIM" runat="server" CssClass="ASPButton" CommandName="Claim" Text="SUBMIT CLAIM" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
