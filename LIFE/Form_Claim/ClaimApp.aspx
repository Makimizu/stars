<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimApp.aspx.cs" Inherits="LIFE.Form_Claim.ClaimApp" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="border-spacing: 0px; width: 100%; font-size: xx-small;">
                ...
                <td> 
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr style="vertical-align: top;">
                            <td style="border-right-style: groove;" class="auto-style1">
                                <table style="border-spacing: 0px; width: 100%;">
                                    <tr>
                                ...
                                <table style="border-spacing: 0px; width: 100%;">
                                    <tr id="TR_TYPE" runat="server" visible="false">
                                        ...
                                        <td rowspan="6" class="auto-style2">
                                            <asp:Label ID="LB_BLACKLIST" runat="server" Font-Bold="true"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>CLAIM CAUSE</td>
                                        <td>
                                            <asp:DropDownList ID="DDL_CAUSE" runat="server" CssClass="ASPDropDownList"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <tr>
                <td id="TD_WARNING" runat="server" style="padding: 12px;border: 2px solid red;" visible="false">
                            ...
                            <td>
                                <table style="border-spacing: 0px; width: 100%;">
                                    <tr>
                                        ...
                                        <td style="width: 14%;">
                                            <asp:Button ID="BT5" runat="server" CssClass="ASPButton" Text="REMARK &amp; LETTERS" Width="100%" OnClick="BT5_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
