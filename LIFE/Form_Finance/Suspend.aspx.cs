    ...
    public partial class Suspend : System.Web.UI.Page
    {
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                LB_DESCR.Text = e.Item.Cells[5].Text;
                LB_BALANCE.Text = e.Item.Cells[4].Text;
                LB_POSTDATE.Text = e.Item.Cells[3].Text;
                DV_SELECTED.Visible = true;
                LB_BACK.Visible = false;

                if (e.Item.Cells[1].Text.Replace("&nbsp;", "") != "")
                {
                    LoadREGNO(e.Item.Cells[1].Text.Replace("&nbsp;", ""), LB_TRXID.Text);
                }
                else
                {
                    LoadOutstanding();
        ...
        protected void LoadREGNO(string regno, string trxid)
        {
            TBL_OUTSTADING.Visible = false;
            IF_REGNO.Visible = true;
            IF_REGNO.Attributes.Remove("onload");
            IF_REGNO.Attributes.Add("onload", " resizeIframe(this)");
            IF_REGNO.Src = "ApplicationOutstanding.aspx?REGNO=" + regno + "&TRXID=" + trxid;
        }

        protected void LoadOutstanding()
        {
            IF_REGNO.Visible = false;
            TBL_OUTSTADING.Visible = true;
            TXT_SEARCH.Text = "";
            TXT_SEARCH.Attributes.Remove("onchange");
            TXT_SEARCH.Attributes.Add("onchange", "ShowProgress()");
            FillDGRSearch();
        }
        ...
        protected void DGR_SUMM_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                LB_ACCNO.Text = e.CommandName + " : " + e.Item.Cells[3].Text;
                DV_RESULT.Visible = true;
                LB_RESULT.Text = "";
                LB_MODE.Text = " a.REGNO is not null ";
                DDL_ACCNO.SelectedValue = e.Item.Cells[0].Text;
        ...
        protected void DGR_SEARCH_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                LoadREGNO(e.Item.Cells[0].Text, LB_TRXID.Text);
            }
        }
