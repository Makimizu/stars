    ...
    public partial class Memo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LB_TIPE.Text = Request.QueryString["type"];
                Setup();
        ...
        protected void Setup()
        {
            ...
            if (LB_TIPE.Text != "")
            {
                ...
                LB_TITLE.Text = DDL_TIPE.SelectedItem.Text;
            }
        }

        protected void FillDDLTipe()
        {
            conn.QueryString = "select CODE,DESCR from PARAM_TIPE_SETTLEMENT where APP_ID = '" + System.Configuration.ConfigurationManager.AppSettings["appid"] + "' order by 1";
            conn.ExecuteQuery();
        ...
        protected void FillDDLRange()
        {
            ...
            conn.QueryString = "select " +
                                ...
                                "where " +
                                "APP_ID = '" + System.Configuration.ConfigurationManager.AppSettings["appid"] + "' " +
        ...
        protected void FillDGR()
        {
            ...
            if (System.Configuration.ConfigurationManager.AppSettings["appid"] != "")
            {
                where = where + " and a.APP_ID='" + System.Configuration.ConfigurationManager.AppSettings["appid"] + "'";
            }
