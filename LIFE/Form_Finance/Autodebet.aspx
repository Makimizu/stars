<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Autodebet.aspx.cs" Inherits="LIFE.Form_Finance.Autodebet" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DataGrid ID="DGR" runat="server" BackColor="White"
            ...
            CellSpacing="1" Font-Names="Tahoma" GridLines="Vertical" ItemStyle-Wrap="true" PageSize="20" CssClass="ASPDatagrid" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <asp:TemplateColumn>
                    <ItemTemplate>
                        <asp:Label ID="LB_LINK" runat="server"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
