<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuspendAccountList.aspx.cs" Inherits="LIFE.Form_Finance.SuspendAccountList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DataGrid ID="DGR_SUMM" runat="server" BackColor="White"
            ...
            <ItemStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" Wrap="True" VerticalAlign="Middle" />
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 50%; text-align: center;">
                                    <asp:LinkButton ID="BT_S" runat="server" CommandName="AutoSettle" Visible="false" Font-Size="Small" ForeColor="Red" ToolTip="AutoSettle"><i class="fa fa-arrow-right"></i></asp:LinkButton></td>
                                <td style="width: 50%; text-align: center;">
                                    <asp:LinkButton ID="BT_IDENTIFIED" runat="server" CommandName="IDENTIFIED" OnClientClick="ShowProgress()" /></td>
                            </tr>
                        </table>
                    </ItemTemplate>
                </asp:TemplateColumn>
