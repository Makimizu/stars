<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RollbackSettlement.aspx.cs" Inherits="LIFE.Form_Finance.RollbackSettlement" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="SQLEXEC" Visible="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="INVOICENO" HeaderText="INVOICE NO"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SETTLEDATE" HeaderText="SETTLE DATE">
                            ...
                            <asp:BoundColumn DataField="PRODUCT" HeaderText="PRODUCT NAME"></asp:BoundColumn>
                            <asp:BoundColumn DataField="AMOUNT" HeaderText="AMOUNT">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="UNITIZE" HeaderText="UNITIZE"></asp:BoundColumn>
                            <asp:TemplateColumn>
