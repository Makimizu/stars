...
namespace UWBOX.Form_Partners
{
    public partial class MedicalLab : System.Web.UI.Page
    {
        ...
        protected void BT_SAVE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                conn.QueryString = "exec SP_PARAM_MEDICAL_LAB_UPSERT " +
                                    "'" + TXT_CODE.Text.Trim() + "'," +
                ...
                if (TXT_CODE.Text == "")
                {
                    Response.Redirect("MedicalLabFrame.aspx?code=" + conn.GetFieldValue("COMPANY_CODE").ToString());
                }
                else
                {
