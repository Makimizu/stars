...
{
    public partial class ParamInsurance : System.Web.UI.Page
    {
        ...
        protected void Setup()
        {
            ...
            conn.QueryString = "select CODE,DESCR from PR_INSURANCE_TYPE";
            conn.ExecuteQuery();
        ...
        protected void LoadRecord(string code)
        {
            ...
            try
            {
                DDL_TIPE.SelectedValue = conn.GetFieldValue("TYPE").ToString();
            }
            catch { }
