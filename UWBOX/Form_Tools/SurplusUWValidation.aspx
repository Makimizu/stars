<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurplusUWValidation.aspx.cs" Inherits="UWBOX.Form_Tools.SurplusUWValidation" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="LB_SURPLUS_GROUP" runat="server" Visible="false"></asp:Label>
        <center>
            <asp:DataGrid ID="DGR" runat="server" AutoGenerateColumns="False" CellPadding="3" GridLines="None" PageSize="20" CssClass="ASPDatagrid" Width="80%" Font-Size="Small" ShowHeader="False" BorderWidth="0px">
                <Columns>
                    <asp:BoundColumn DataField="ERR_DESCR">
