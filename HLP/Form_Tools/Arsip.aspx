<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Arsip.aspx.cs" Inherits="HLP.Form_Tools.Arsip" %>
            ...
            <tr>
                <td>
                    <table style="border-spacing:0px;">
                        ...
                        <tr>
                            <td class="style1" valign="top">KETERANGAN</td>
                            <td valign="top">
                ...
                <td>
                    <asp:DataGrid ID="DGR_ARSIP" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="REMARK" HeaderText="DOKUMEN"></asp:BoundColumn>
