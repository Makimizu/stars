<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Header.aspx.cs" Inherits="HLP.Standard.Header" %>
        ...
        <table style="width: 100%; top: 0px; left: 0px; position: absolute;">
            <tr>
                ...
                <td style="text-align: right;">
                    <asp:Label ID="LBL_USER" runat="server"  Font-Size="X-Small" ForeColor="Yellow"></asp:Label>
                    <br />

                    <asp:LinkButton ID="LB_LOGOUT" runat="server" Font-Bold="True"  Font-Size="X-Small" ForeColor="Yellow" OnClick="LB_LOGOUT_Click">LOGOUT</asp:LinkButton>
                    &nbsp;<asp:LinkButton ID="LB_PASSWORD" runat="server" Font-Bold="True"  Font-Size="X-Small" ForeColor="Yellow" OnClick="LB_PASSWORD_Click">CHANGE PASSWORD</asp:LinkButton>
