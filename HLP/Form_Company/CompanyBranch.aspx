<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyBranch.aspx.cs" Inherits="HLP.Form_Company.CompanyBranch" %>
                                ...
                                <asp:DataGrid ID="DGR_KORESPONDEN" runat="server" CellPadding="4" ForeColor="#333333" OnItemCommand="DGR_ACCOUNT_ItemCommand"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="EMAIL">
                                            <ItemTemplate>
                                                <asp:TextBox ID="TXT_PICEMAIL" runat="server" CssClass="ASPTextBox" Width="150px" MaxLength="100"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
