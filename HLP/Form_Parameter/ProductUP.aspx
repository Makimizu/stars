<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductUP.aspx.cs" Inherits="HLP.Form_Parameter.ProductUP" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        PageSize="20" ItemStyle-Wrap="true" AutoGenerateColumns="False" OnItemCommand="DGR_ItemCommand" OnItemDataBound="DGR_ItemDataBound" ShowFooter="True">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="UP_STD" Visible="False"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="UP">
                                <FooterTemplate>
