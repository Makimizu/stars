    ...
    public partial class Parameter_Basic : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                GlobalUse.SetReadOnly(Page, GlobalUse.GetUserMgmt(Session["s"].ToString(), "UserID"), "Basic Parameters");
            }
        }
        ...
        {
            conn.QueryString = "exec [HEALTHPROPOSAL].[dbo].SP_GET_TABLE_INFO '" + tablename + "'";
            conn.ExecuteQuery();
            DataTable dt;
            dt = new DataTable();
            dt = conn.GetDataTable().Copy();
