<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parameters.aspx.cs" Inherits="GLIFE.Form_Parameter.Parameters" %>
                                ...
                                <tr>
                                    <td>
                                        <asp:DataGrid ID="DGR1" runat="server" BackColor="White"
                                            ...
                                            OnPageIndexChanged="DGR1_PageIndexChanged" Width="95%" ItemStyle-Wrap="true">
                                            <SelectedItemStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
