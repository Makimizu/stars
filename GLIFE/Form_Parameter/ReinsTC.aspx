<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReinsTC.aspx.cs" Inherits="GLIFE.Form_Parameter.ReinsTC" %>
                        ...
                        <tr style="vertical-align: top;">
                            <td>
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        <td>PAMENT FREQUENCY</td>
                                        <td><asp:Label ID="lblPaymentFreq" runat="server" Font-Bold="true"></asp:Label></td>
                                    </tr>

                                    <tr>
                                        <td>PENURUNAN RESIKO</td>
                                        <td>
                                            <asp:Label ID="lblResiko" runat="server" Font-Bold="true"></asp:Label>
                                            &nbsp;
                                            <asp:Button ID="btnViewResiko" Visible="false" runat="server" CssClass="ASPButton" Text="View" OnClick="btnViewResiko_Click"/>
                                            <asp:Label Visible="false" runat="server" ID="lblResikoCode"></asp:Label>
                                        </td>
                                    </tr>
                ...
                <table style="border-spacing: 0px; width: 100%;">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:DataGrid ID="DGRTAHUNAN" runat="server" CssClass="ASPDatagrid" BackColor="White" BorderColor="#999999" BorderWidth="1px" CellPadding="3" GridLines="Vertical" BorderStyle="None">
                                <AlternatingItemStyle BackColor="#DCDCDC" />
                                <ItemStyle Wrap="False" HorizontalAlign="Center" BackColor="#EEEEEE" ForeColor="Black" />
                                <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                                <HeaderStyle Wrap="False"
                            ...
                            <asp:DataGrid ID="DGRBULANAN" runat="server" CssClass="ASPDatagrid" BackColor="White" BorderColor="#999999" BorderWidth="1px" CellPadding="3" GridLines="Vertical" BorderStyle="None">
                                <AlternatingItemStyle BackColor="#DCDCDC" />
                                <ItemStyle Wrap="False" HorizontalAlign="Center" BackColor="#EEEEEE" ForeColor="Black" />
                                <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                                <HeaderStyle Wrap="False"
