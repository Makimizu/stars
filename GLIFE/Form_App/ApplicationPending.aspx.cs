    ...
    public partial class ApplicationPending : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            conn.QueryString = "select " +
                                ...
                                "left join APPLICATION_MASTER_PENDING b on a.CODE = b.PENDING_CODE and b.REGNO = '" + LB_REGNO.Text + "' " +
                                "where " +
                                "a.PROCESS_CODE = 'UW'";
            conn.ExecuteQuery();
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                ClientScript.RegisterStartupScript(GetType(), "", "<script language='javascript'>parent.appapppendingbody.location.href = 'ApplicationPending" + e.Item.Cells[0].Text + ".aspx?ID=" + LB_REGNO.Text + "&type=" + e.Item.Cells[0].Text + ReadOnly + "';</script>");
            }
