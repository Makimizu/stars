<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppRejectCancelList.aspx.cs" Inherits="GLIFE.Form_App.AppRejectCancelList" %>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn Visible="false">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:Button ID="BT_DEL" runat="server" CssClass="ASPButton" CommandName="Delete" Text="X" ForeColor="White" BackColor="Red" ToolTip="Reinstate" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
