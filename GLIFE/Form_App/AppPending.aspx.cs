    ...
    public partial class AppPending : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            ...
            if (TXT_COMPANY.Text.Trim() != "")
                where = where + " and cc.COMPANY_NAME like '%" + TXT_COMPANY.Text.Trim() + "%' ";

            if (TXT_FULLNAME.Text.Trim() != "")
                where = where + " and cc.FULLNAME like '%" + TXT_FULLNAME.Text.Trim() + "%' ";
