<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppPOSHistory.aspx.cs" Inherits="GLIFE.Form_App.AppPOSHistory" %>
                    ...
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr style="vertical-align: top;">
                            ...
                            <td style="width: 50%;">
                                <table style="border-spacing: 0px; width: 100%;">
                                    <tr>
                                        <td style="width: 120px;">ENDORSEMENT TYPE</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>APPROVAL DATE</td>
                                        <td>
                                            <asp:TextBox ID="TXT_APVDATE1" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="ceDate1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_APVDATE1">
                                            </ajaxToolkit:CalendarExtender>
                                            &nbsp;-&nbsp;
                                            <asp:TextBox ID="TXT_APVDATE2" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_APVDATE2">
                                            </ajaxToolkit:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="APV_DATE" HeaderText="APV. DATE">
                            ...
                            <asp:BoundColumn DataField="ENDORSEMENT_TYPE_DESCR" HeaderText="TYPE"></asp:BoundColumn>
                            <asp:BoundColumn DataField="AR_AMOUNT" HeaderText="AR AMOUNT">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" ForeColor="Green" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="AP_AMOUNT" HeaderText="AP AMOUNT">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" ForeColor="Red" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="SETOFF" HeaderText="SET OFF">
                                <HeaderStyle HorizontalAlign="Right" />
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                                    <asp:Button ID="BT_REPORT" runat="server" Text="R" CssClass="ASPButton" CommandName="Report" BackColor="Green" ForeColor="White" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
