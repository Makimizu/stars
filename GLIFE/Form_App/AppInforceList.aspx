<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppInforceList.aspx.cs" Inherits="GLIFE.Form_App.AppInforceList" %>
                            ...
                            <td style="width: 50%;">
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        <td>DOB</td>
                                        <td>
                                            <asp:TextBox ID="txtDOB" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="ceDOB" runat="server" Format="dd/MM/yyyy" TargetControlID="txtDOB">
                                ...
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:Label ID="LB_LAPSE" runat="server" Visible="False"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemStyle />
                                <ItemTemplate>
                                    <asp:Button ID="BT_CLAIM" runat="server" CssClass="ASPButton" Text="CLAIM" ForeColor="Red" CommandName="Claim" />
                                    <asp:Button ID="BT_ENDORSEMENT" runat="server" CssClass="ASPButton" Text="ENDORSEMENT" ForeColor="Blue" CommandName="Endorsement" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
