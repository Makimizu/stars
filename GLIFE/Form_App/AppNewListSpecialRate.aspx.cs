...
{
    public partial class AppNewListSpecialRate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LB_TRACK.Text = "SP"; //Request.QueryString["track"].ToString();
                //FillDGR();
            }
        }
        ...
        protected void FillDGR()
        {
            ...
            conn.QueryString = "select " +
                                ...
                                "inner join [GLIFE_PROPOSAL].[dbo].[APPLICATION_SPECIALRATE] sp ON a.REGNO =sp.REGNO AND DATECONFIRM IS NULL " +
                                "where " +
                                "1=1 " + where +
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                Response.Redirect("ApplicationFrameSpecialRate.aspx?ID=" + e.Item.Cells[1].Text + ReadOnly);
