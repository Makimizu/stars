<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationRemark.aspx.cs" Inherits="GLIFE.Form_App.ApplicationRemark" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="border-spacing: 0px; width: 100%;">
            ...
            <tr id="TR_INSERT" runat="server">
                <td>
                    <asp:TextBox ID="TXT_REMARK" runat="server" Width="90%" TextMode="MultiLine" Height="80px" Font-Size="Small" placeholder="Type your remark here ..." CssClass="ASPTextBox"></asp:TextBox>
