<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppPOS.aspx.cs" Inherits="GLIFE.Form_App.AppPOS" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                <HeaderTemplate>
                                    <asp:Button ID="BT_EXECUTE" runat="server" BackColor="Yellow" CommandName="Execute" CssClass="ASPButton" Text="N" /><br />
