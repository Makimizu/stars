<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppNewListSpecialRate.aspx.cs" Inherits="GLIFE.Form_App.AppNewListSpecialRate" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDL_PREMIUM" runat="server" CssClass="ASPDropDownList">
                                                ...
                                                <asp:ListItem Value="SUBSTD">SUB STANDARD</asp:ListItem>
                                                <asp:ListItem Value="STD">STANDARD</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        CellSpacing="1" Font-Names="Tahoma" GridLines="Vertical" OnItemCommand="DGR_ItemCommand" Width="100%" ItemStyle-Wrap="true" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanged="DGR_PageIndexChanged" PageSize="20" OnItemDataBound="DGR_ItemDataBound" CssClass="ASPDatagrid">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="UW_CODE" HeaderText="U/W<BR>CODE">
                             ...
                             <asp:BoundColumn DataField="PENDING" HeaderText="FLAG">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="NETT_PREMIUM" HeaderText="NET PREMIUM">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" ForeColor="Green" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ADJ_PREMIUM" HeaderText="ADJ PREMIUM">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" ForeColor="Blue" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="CONFIRMED_DATE" HeaderText="CONFIRMED<BR>DATE"></asp:BoundColumn>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                <HeaderTemplate>
                                    <asp:CheckBox ID="CB_ALL" runat="server" OnCheckedChanged="CB_ALL_CheckedChanged" AutoPostBack="True" /><br />
                                    <asp:Button ID="BT_APPROVE" runat="server" CssClass="ASPButton" CommandName="Approve" Text="APPROVE" />
                                </HeaderTemplate>
                                <ItemTemplate>
