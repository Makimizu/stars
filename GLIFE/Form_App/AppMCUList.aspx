<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppMCUList.aspx.cs" Inherits="GLIFE.Form_App.AppMCUList" %>
                            ...
                            <td style="width: 50%;">
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        <td>REQUESTED</td>
                                        <td>
                                            <asp:DropDownList ID="DDL_REQUESTED" runat="server" CssClass="ASPDropDownList">
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="UW_CODE" HeaderText="UW<BR>CODE">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundColumn>
