<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationHeaderSpecialRate.aspx.cs" Inherits="GLIFE.Form_App.ApplicationHeaderSpecialRate" %>
                            ...
                            <td style="width: 25%;">
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr id="TR_PENDING" runat="server">
                                        <td><asp:Label ID="LB_URLTEST" runat="server" Font-Bold="True"></asp:Label></td>
                                        <td>
                                            ...
                                            <ItemTemplate>
                                                <table style="border-spacing: 0px; width: 100%;">
                                                    <tr style="vertical-align: top;">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="TXT_COMMENT" runat="server" Height="25px" Width="98%" Visible="false" MaxLength="1000" TextMode="MultiLine" CssClass="ASPTextBox" placeholder="Type your reason comment ..."></asp:TextBox>
                                                            <br />
                                                            <!--
                                                            <asp:DropDownList runat="server" ID="DDL_APPROVAL_GROUP" Width="100%" CssClass="select2-selection select2-selection--single">
                                                            </asp:DropDownList>-->
                                                        </td>
                                                    </tr>
                                                </table>
