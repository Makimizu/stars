<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchListPOS.aspx.cs" Inherits="GLIFE.Form_Saving.BatchListPOS" %>
                ...
                <td>
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TXT_POLICYSEARCH" runat="server" AutoPostBack="true" Width="95%" CssClass="ASPTextBox"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <table style="border-spacing: 0px; width: 100%;">
                                    <tr>
                                        <td>
                                            <asp:Button ID="BT_SEARCH" runat="server" CssClass="ASPButton" Text="SEARCH BATCH" OnClick="BT_SEARCH_Click" Width="100px" />&nbsp;<asp:Button ID="BT_NEW" runat="server" CssClass="ASPButton" Text="NEW UPLOAD" OnClick="BT_NEW_Click" BackColor="Blue" ForeColor="White" Width="100px" OnClientClick="ShowProgress();" /></td>
                ...
                <td>
                    <asp:DataGrid ID="DGR_POLICY" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="CONTRIB" HeaderText="AMOUNT">
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="BT_DELETE" runat="server" CssClass="ASPButton" Text="X" BackColor="Red" ForeColor="White" CommandName="Delete" OnClientClick="ShowProgress();" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
