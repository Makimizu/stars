<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchUploadPOS.aspx.cs" Inherits="GLIFE.Form_Saving.BatchUploadPOS" %>
        ...
        <div id="DV_UPLOAD" runat="server" visible="false">
            <table style="border-spacing: 0px; width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="LBT_XLS" runat="server" Text="XLS File Template" OnClick="LBT_XLS_Click"></asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td></td>
