            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        CellSpacing="1" Font-Names="Tahoma" GridLines="Vertical" OnItemCommand="DGR_ItemCommand" Width="150%" ItemStyle-Wrap="true" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanged="DGR_PageIndexChanged" PageSize="20" CssClass="ASPDatagrid">
                        ...
                        <Columns>
                            ...
                            <%--<asp:BoundColumn DataField="BRANCH_CODE" HeaderText="BRANCH CODE"></asp:BoundColumn>  
                            <asp:BoundColumn DataField="BRANCH_PIC" HeaderText="BRANCH PIC"></asp:BoundColumn> 
                            ...
                            <asp:BoundColumn DataField="PENDING_CODE" HeaderText="PENDING CODE"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SEQ" HeaderText="SEQ"></asp:BoundColumn>  
                            <asp:BoundColumn DataField="DATE_CLAIM" HeaderText="DATE CLAIM"></asp:BoundColumn>--%>
                            ...
                            <asp:BoundColumn DataField="PENDING_CODE" Visible="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SEQ" Visible="false"></asp:BoundColumn> 
                            <asp:BoundColumn DataField="CLAIM_TYPE" Visible="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="LOCATION_CODE" Visible="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="LASTCHANGEBY" HeaderText="USER SEND EMAIL">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                            </asp:BoundColumn>                        
                            <asp:BoundColumn DataField="TGL_AWAL" HeaderText="TGL SEND EMAIL">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            ...
                            <asp:TemplateColumn HeaderText="PIC EMAIL">
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="BT_EMAIL" runat="server" CommandName="Process" CssClass="ASPButton" Text="SEND" ForeColor="White" BackColor="Green" Font-Bold="True" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
