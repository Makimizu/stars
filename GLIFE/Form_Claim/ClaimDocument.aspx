<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimDocument.aspx.cs" Inherits="GLIFE.Form_Claim.ClaimDocument" %>
                ...
                <td>
                    <asp:DataGrid ID="DGR_DOCS" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                    <asp:Label ID="LB_DESCR" runat="server" Visible="False" Font-Size="8pt" ForeColor="Gray"></asp:Label>
