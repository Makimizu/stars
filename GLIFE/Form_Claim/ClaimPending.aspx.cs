    ...
    public partial class ClaimPending : System.Web.UI.Page
    {
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select")
            {
                ...
                if (Request.QueryString["readonly"] == "1")
                    ReadOnly = "&readonly=1";
                ClientScript.RegisterStartupScript(GetType(), "", "<script language='javascript'>parent.claimpendingbody.location.href = 'ClaimPending" + e.Item.Cells[0].Text + ".aspx?REGNO=" + LB_REGNO.Text + "&SEQ=" + LB_SEQ.Text + "&type=" + e.Item.Cells[0].Text + ReadOnly + "';</script>");
            }
