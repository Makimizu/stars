...
namespace GLIFE.Form_Claim
{
    public partial class ClaimReg : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            ...
            if (LB_TRACK.Text != "6")
                where = where + " a.LAST_TRACK = " + LB_TRACK.Text + " ";

            if (LB_TRACK.Text == "6")
                where = where + " a.TRACK = " + LB_TRACK.Text + " and c.USER_ENDBY  is null ";
            ...
            conn.QueryString = "select " +
                                ...
                                "left join TRACK_DATA c on a.REGNO + '-' + convert(varchar(10),a.SEQ) = c.OWNER collate database_default and c.SEQ = 6 " +
                                "where " + where + " " +
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                try
                {
                    conn.QueryString = "exec SP_APPLICATION_CLAIM_MASTER_ROLLBACK '" + e.Item.Cells[1].Text + "'," + e.Item.Cells[2].Text;
