...
{
    public partial class ReportPOSAPUPPT : System.Web.UI.Page
    {
        ...
        {
            LB_RESULT.Text = "";
            string policyno = "", nama = "", produk = "", regno = "", group = "", start = "", end = "", track = "";

            if (TXT_POLICYNO.Text.Trim() != "")
                policyno = TXT_POLICYNO.Text.Trim();
            ...
            conn.QueryString = "EXEC [GLIFE].[dbo].[SP_POS_TRANSACTION_CORPORATE] '"+ policyno + "', '" + nama + "', '" + produk + "', '" + group + "', '" + start + "', '" + end + "'";
            conn.ExecuteQuery(150000);
        ...
        protected void BT_EXCEL_Click(object sender, EventArgs e)
        {
            ...
            string filename = "report_pos_apuppt_korporasi_" + unixTime.ToString();
            ...
            //GlobalUse.ExportToExcel(dt, this, filename);
