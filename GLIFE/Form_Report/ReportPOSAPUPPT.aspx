<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportPOSAPUPPT.aspx.cs" Inherits="GLIFE.Form_Report.ReportPOSAPUPPT" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="REG_DATE" HeaderText="TGL. TRANSAKSI"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SUMINS" HeaderText="SUM INSURED"></asp:BoundColumn>
                            <%--<asp:BoundColumn DataField="AP_AMOUNT" HeaderText="INCURRED AMOUNT"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SETTLED_AMOUNT" HeaderText="TO BE PAID"></asp:BoundColumn>--%>
                            <asp:BoundColumn DataField="FLAG" HeaderText="STATUS BLACKLIST"></asp:BoundColumn>
                            <asp:BoundColumn DataField="TC_DESCR" HeaderText="JENIS TRANSAKSI"></asp:BoundColumn>
