...
{ 
    public partial class ReportCLAIMAPUPPT : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            ...
            conn.QueryString = "EXEC [GLIFE].[dbo].[SP_CLAIM_TRANSACTION_CORPORATE] '" + policyno + "', '" + nama + "', '" + produk + "', '" + group + "', '" + start + "', '" + end + "'";
            conn.ExecuteQuery(150000);
        ...
        protected void BT_EXCEL_Click(object sender, EventArgs e)
        {
            ...
            string filename = "report_claim_apuppt_korporasi_" + unixTime.ToString();
