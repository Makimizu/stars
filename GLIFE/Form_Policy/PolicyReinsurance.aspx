<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyReinsurance.aspx.cs" Inherits="GLIFE.Form_Policy.PolicyReinsurance" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="border-spacing: 0px;">
            <tr>
                <td>
                    <table id="TBL_REINS" runat="server" style="border-spacing: 0px; width: 100%;">
                        <tr>
