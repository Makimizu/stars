<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InquiryScreenPopup.aspx.cs" Inherits="GLIFE.Form_Tools.InquiryScreenPopup" %>
                    ...
                    <table style="border-spacing: 0px;">
                        <tr style="vertical-align: top;">
                            ...
                            <td>
                                ...
                                <asp:Label ID="LB_TARGETCODE" runat="server" Visible="False"></asp:Label>
                                <asp:Label ID="LB_TARGETDESCR" runat="server" Visible="False"></asp:Label>
                                <br />
                                <br />
