<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InquiryScreen.aspx.cs" Inherits="GLIFE.Form_Tools.InquiryScreen" %>
                ...
                <td>
                    <table style="border-spacing: 0px;">
                        <tr style="vertical-align: top;">
                            ...
                            <td>
                                <asp:Button ID="BT_SEARCH" runat="server" CssClass="ASPButton" OnClick="BT_SEARCH_Click" Text="SEARCH" Width="68px" />
                                <br />
                                <asp:Button ID="BT_NEW" runat="server" CssClass="ASPButton" Text="NEW RECORD" Width="100px" Font-Bold="True" ForeColor="Blue" Visible="False" OnClick="BT_NEW_Click" />
            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" CellPadding="4" PageSize="20" OnPageIndexChanged="DGR_PageIndexChanged" OnItemCommand="DGR_ItemCommand"
                        AllowPaging="True" GridLines="None" CssClass="ASPDatagrid" ForeColor="#333333" Width="100%">
