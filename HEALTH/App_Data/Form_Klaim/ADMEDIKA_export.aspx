<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMEDIKA_export.aspx.cs" Inherits="HEALTH.Form_Klaim.ADMEDIKA_export" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <td>
                                <table style="border-spacing: 0px;">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDL_PR" runat="server" CssClass="ASPDropDownList" AutoPostBack="True">
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" CssClass="ASPDatagrid" PageSize="15" AutoGenerateColumns="False" Width="350px" BackColor="White" BorderColor="#000066" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="APPROVALDATE" HeaderText="TGL APPROVAL">
                            ...
                            <asp:BoundColumn DataField="APPROVED" HeaderText="BAYAR">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
