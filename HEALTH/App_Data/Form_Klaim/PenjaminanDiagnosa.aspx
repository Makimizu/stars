<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PenjaminanDiagnosa.aspx.cs" Inherits="HEALTH.Form_Klaim.PenjaminanDiagnosa" %>
        ...
        <table style="position: absolute; top: 0px; left: 0px; border-spacing: 0px;">
            <tr style="vertical-align: top;">
                <td>
                    ...
                    <asp:TextBox ID="TXT_ICD" runat="server" CssClass="ASPTextBox"></asp:TextBox>
