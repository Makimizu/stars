    ...
    public partial class ClaimPending : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            ...
            for (int i = 0; i < DGR.Items.Count; i++)
            {
                ...
                if (DGR.Items[i].Cells[16].Text == "1")
                {
                    cb.Visible = true;
                    DGR.Items[i].Cells[5].ForeColor = System.Drawing.Color.Green;
                    DGR.Items[i].Cells[5].Font.Bold = true;
                    DGR.Items[i].Cells[6].ForeColor = System.Drawing.Color.Green;
                    DGR.Items[i].Cells[6].Font.Bold = true;
                }
                else
                {
        ...
        protected void BT_PROSES_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < DGR.Items.Count; i++)
            {
                ...
                if (cb.Checked && cb.Visible == true)
                {
                    try
                    {
                        ...
                        var dataBayar = DGR.Items[i].Cells[12].Text;
            ...
            if (LB_TRACK.Text == "1")
            {
                if (iCount > 0)
                {
                    showMessage(iCount + " Klaim berhasil di verifikasi", "success");
                }
            }
