<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPList.aspx.cs" Inherits="HEALTH.Form_Klaim.CPList" %>
                    ...
                    <asp:Button ID="BT_SEARCH" runat="server" CssClass="ASPButton" Text="SEARCH" OnClick="BT_SEARCH_Click" />
                        <asp:DataGrid ID="DGR_REPORT" runat="server" AutoGenerateColumns="False" AllowSorting="True" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="KODE_DIAGNOSA" HeaderText="KODE DIAGNOSA" SortExpression="KODE_DIAGNOSA"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="TOTAL_BIAYA_CP" HeaderText="CP Total Cost" DataFormatString="{0:N2}" SortExpression="TOTAL_BIAYA_CP"></asp:BoundColumn>
                            </Columns>
