...
&nbsp;-
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:100px;">TGL KLAIM</td>
                                        <td>
                                            <asp:TextBox ID="TXT_TGLKLM1" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;">01/01/2017</asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_TGLKLM1">
                                            </ajaxToolkit:CalendarExtender>
                                            &nbsp;-
                                            <asp:TextBox ID="TXT_TGLKLM2" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_TGLKLM2">
                                            </ajaxToolkit:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <td>
                                <table style="border-spacing: 0px;">
                                    <tr>
                                        <td style="width: 100px;">Total Batch</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Total Billed</td>
                                        <td>
                                            <asp:Label ID="LB_BILLED" runat="server" CssClass="ASPLabel" Font-Bold="True" ForeColor="Green"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Total Paid</td>
                                        <td>
                                            <asp:Label ID="LB_PAID" runat="server" CssClass="ASPLabel" Font-Bold="True" ForeColor="Blue"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Total Outstanding</td>
                                        <td>
                                            <asp:Label ID="LB_OUTSTANDING" runat="server" CssClass="ASPLabel" Font-Bold="True" ForeColor="Red"></asp:Label></td>
                                    </tr>
                                </table>
