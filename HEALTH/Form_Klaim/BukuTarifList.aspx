<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BukuTarifList.aspx.cs" Inherits="HEALTH.Form_Klaim.BukuTarifList" %>
                    ...
                    <asp:Button ID="BT_SEARCH" runat="server" CssClass="ASPButton" Text="SEARCH" OnClick="BT_SEARCH_Click" />
                        <asp:DataGrid ID="DGR_REPORT" runat="server" AutoGenerateColumns="False" AllowSorting="True" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="PATH_DOKUMEN" Visible="False"></asp:BoundColumn>
