...
{
    public partial class CPbyTrICD: System.Web.UI.Page
    {
        ...
        private DataTable GetReportData(string searchQuery,string searchQuery1)
        {
            ...
            string query = @"
                        SELECT [KODE_PROVIDER]      ,[NAMA_PROVIDER]      ,[KODE_ICD]      ,[DIAGNOSA]  ,[LOS]    ,[Kelas 3]   ,[Kelas 2]      ,[Kelas 1]
                       ,[VIP]      ,[VVIP]      ,[VIP Utama], createdate FROM [V_PROVIDER_TARIF_ICD_REPORT] WHERE 1=1";
        ...
        protected void FillDGRReport(string searchQuery = "", string searchQuery1 = "")
        {
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                noDataRow["KODE_PROVIDER"] = "No Data Available";
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage package = new ExcelPackage())
            {
                ...
                string filePath = Path.Combine(folderPath, "Report_Tarif_ICD_by_Provider_Report.xlsx");
