                ...
                <td>
                    <table id="TBL_ACC" runat="server" visible="false" style="border-spacing: 0px;">
                        ...
                        <tr>
                            <td>KODE TPA</td>
                            <td>:</td>
                            <td><asp:DropDownList ID="ddKodeTPA" runat="server" CssClass="ASPDropDownList">
                                </asp:DropDownList></td>
                        </tr>
                    </table>
                </td>
                                ...
                                <ItemTemplate>
                                    <table style="border-spacing: 0px;">
                                        ...
                                        <tr>
                                            <td>KODE TPA</td>
                                            <td>:</td>
                                            <td><asp:DropDownList ID="ddKodeTPA2" runat="server" CssClass="ASPDropDownList"></asp:DropDownList></td>
                                        </tr>
                                        <tr>
                                            <td>STATUS</td>
                                            <td>:</td>
