...
<body>
    <form id="form1" runat="server">
        ...
        <table style="position: absolute; top: 0px; left: 0px; border-spacing: 0px; width: 100%; transform: scale(0.85); transform-origin: top left;">
            <tr>
                <td>
                            ...
                            <td>
                                <table style="border-spacing: 0px;">
                                    ...
                                    <tr>
                                        <td>STATUS</td>
                                        <td>
                                            <asp:DropDownList ID="DDL_STATUS" runat="server" CssClass="ASPDropDownList" Enabled="True">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="DDL_TUJUAN" runat="server" CssClass="ASPDropDownList">
                                            ...
                                            <asp:ListItem Text="Draft Adendum" Value="Adendum"></asp:ListItem>
                                            <%--<asp:ListItem Text="Perjanjian Kerja sama Sementara" Value="Kerjasama_Sementara"></asp:ListItem>
                                            <asp:ListItem Text="Surat Penawaran Kerja Sama" Value="Penawaran_Kerjasama"></asp:ListItem>--%>
                                            <asp:ListItem Text="Surat Pengajuan Perpanjangan PKS" Value="Perpanjangan_PKS"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:Button ID="BT_DOWNLOAD" runat="server" CssClass="ASPButton" OnClick="BT_DOWNLOAD_Click" Text="GENERATE" Font-Bold="True" />
                ...
                <td>
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr>
                            ...
                            <td style="width: 12%;">
                                <asp:Button ID="BT8" runat="server" CssClass="ASPButton" Text="CLINICAL PATHWAY (CP)" Width="100%" OnClick="BT8_Click" BackColor="#333333" Font-Bold="True" ForeColor="White" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td class="TDBGColor" style="width: 70%;">
