...
<body>
    <form id="form1" runat="server">
        ...
        <table style="position: absolute; top: 0px; left: 0px; border-spacing: 0px;">
            <tr>
                <td>
                    <table style="border-spacing: 0px;">
                        ...
                        <tr>
                            <td class="auto-style1">TGL BERLAKU</td>
                            <td class="auto-style1">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="TXT_TRF_TGLBERLAKU" runat="server" CssClass="ASPTextBox" Font-Size="Smaller" Width="106px" Enabled="False" Height="16px"></asp:TextBox>
                ...
                <td>
                    <table style="border-spacing: 0px;">
                        <tr style="width: 80px;">
                            ...
                            <td>
                                <asp:Button ID="BT_TEMPLATE_DOWNLOAD" runat="server" CssClass="ASPButton" OnClick="BT_TEMPLATE_DOWNLOAD_Click" Text="TEMPLATE EXCEL" />
                            </td>
                        </tr>
                        <tr>
                            <td>PILIH TEMPLATE TARIF</td>
                            <td>
                                <input id="TXT_FILE_UPLOAD_TEMPLATE" runat="server" name="TXT_FILE_UPLOAD_TEMPLATE" type="file"
                                    class="ASPTextBox" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="BT_TRF_UPLOAD_TEMPLATE" runat="server" CssClass="ASPButton" OnClick="BT_TRF_UPLOAD_TEMPLATE_Click" Text="UPLOAD TEMPLATE EXCEL" />
                            </td>
                        </tr>
                ...
                <td>
                    <table style="border-spacing: 0px;">
                        <tr style="width: 80px;">
                            <td>BUKU TARIF</td>
                            <td>
                                <input id="TXT_FILE_UPLOAD_BUKU_TARIF" runat="server" name="TXT_FILE_UPLOAD_BUKU_TARIF" type="file"
                                    class="ASPTextBox" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="BT_TRF_UPLOAD" runat="server" CssClass="ASPButton" OnClick="BT_TRF_UPLOAD_Click" Text="UPLOAD BUKU TARIF" />
                            </td>
                        </tr>
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DGR_TARIF_DOCUMENT" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None"
                        BorderWidth="1px" CellPadding="3" PageSize="20" GridLines="Vertical" CssClass="ASPDatagrid" AutoGenerateColumns="False" OnItemCommand="DGR_TARIF_DOCUMENT_ItemCommand">
                        <ItemStyle BackColor="#EEEEEE" ForeColor="Black" Wrap="False" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left" VerticalAlign="Top" />
                        <AlternatingItemStyle BackColor="#DCDCDC" />
                        <Columns>
                            <asp:BoundColumn DataField="ID" Visible="False"></asp:BoundColumn>
                            <asp:BoundColumn DataField="PATH" HeaderText="FILE NAME"></asp:BoundColumn>
