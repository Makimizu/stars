...
<body>
    <form id="form1" runat="server">
        <table style="position: absolute; top: 0px; left: 0px; border-spacing: 0px; width: 100%;">
            ...
            <tr>
                <td>
                    <asp:Button ID="BT_SAVE" runat="server" CssClass="ASPButton" Font-Bold="True" OnClick="BT_SAVE_Click" Text="SAVE" Width="50px" />
					<asp:Button ID="BT_SAVE_DETAIL" runat="server" CssClass="ASPButton" Font-Bold="True" Text="SAVE" Width="50px" OnClick="BT_SAVE_DETAIL_Click" />
