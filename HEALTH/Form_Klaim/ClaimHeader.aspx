<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimHeader.aspx.cs" Inherits="HEALTH.Form_Klaim.ClaimHeader" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT2" runat="server" CssClass="ASPButton" Text="DIAGNOSA" Width="90%" OnClick="BT2_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT8" runat="server" CssClass="ASPButton" Text="SURG. CTGR" Width="90%" OnClick="BT8_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT0" runat="server" CssClass="ASPButton" Text="ADD INFO" Width="90%" OnClick="BT0_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT9" runat="server" CssClass="ASPButton" Text="REMARK" Width="90%" OnClick="BT9_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT1" runat="server" CssClass="ASPButton" Text="ARSIP" Width="90%" OnClick="BT1_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT_ADD_REASON" runat="server" CssClass="ASPButton" Text="ADD REASON" Width="90%" OnClick="BT_ADD_REASON_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT4" runat="server" CssClass="ASPButton" Text="TRACK" Width="90%" OnClick="BT4_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <%--ANDEZ ADMEDIKA--%>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT_API" runat="server" CssClass="ASPButton" Text="API TRACK" Width="90%" OnClick="BT_API_Click" Height="30px" Font-Bold="True" CausesValidation="False" Visible="false" />
                            </td>
                        </tr>
                        <%--NDEZ ADMEDIKA--%>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT_SURAT" runat="server" CssClass="ASPButton" Text="SURAT" Width="90%" OnClick="BT_SURAT_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT5" runat="server" CssClass="ASPButton" Text="REV HISTORY" Width="90%" OnClick="BT5_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT_HP" runat="server" CssClass="ASPButton" Text="CLAIM HIST." Width="90%" OnClick="BT_HP_Click" Height="30px" Font-Bold="True" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT_TC" runat="server" CssClass="ASPButton" Text="TC POLIS" Width="90%" Height="30px" Font-Bold="True" OnClick="BT_TC_Click" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="BT_FINANCE" runat="server" CssClass="ASPButton" Text="FINANCE" Width="90%" Height="30px" Font-Bold="True" CausesValidation="False" OnClick="BT_FINANCE_Click" />
                            </td>
                        </tr>
                        <tr id="TR_DISCOUNT" runat="server">
                            <td style="text-align: center;">
                                <asp:Button ID="BT_DISCOUNT" runat="server" CssClass="ASPButton" Text="DISCOUNT" Width="90%" Height="30px" Font-Bold="True" OnClick="BT_DISCOUNT_Click" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr id="TR_APL" runat="server">
                            <td style="text-align: center;">
                                <asp:Button ID="BT_APL" runat="server" CssClass="ASPButton" Text="CETAK APL" Width="90%" Height="30px" Font-Bold="True" OnClick="BT_APL_Click" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr id="TR_PENDING" runat="server">
                            <td style="text-align: center;">
                                <asp:Button ID="BT6" runat="server" CssClass="ASPButton" Text="PENDING" Width="90%" OnClick="BT6_Click" BackColor="Yellow" Font-Bold="True" ForeColor="#FF6600" Height="30px" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr id="TR_REJECT" runat="server">
                            <td style="text-align: center;">
                                <asp:Button ID="BT7" runat="server" CssClass="ASPButton" Text="TOLAK" Width="90%" BackColor="Pink" Font-Bold="True" ForeColor="Red" OnClick="BT7_Click" Height="30px" CausesValidation="False" />
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table style="border-spacing: 0px; width: 100%;">
                        ...
                        <tr style="vertical-align: top;">
                                            ...
                                            <table style="border-spacing: 0px;">
                                                    ...
                                                    <td>
                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <%--<ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" TargetControlID="TXT_TGLCLAIM">--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <%--<ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" Format="yyyy-MM-dd" TargetControlID="TXT_TGLRAWATDARI">--%>
                                                                </ajaxToolkit:CalendarExtender>
                                                                -
                                                    <asp:TextBox ID="TXT_TGLRAWATSAMPAI" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                                                ...
                                                                <%--<ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" Format="yyyy-MM-dd" TargetControlID="TXT_TGLRAWATSAMPAI">--%>
                                                                </ajaxToolkit:CalendarExtender>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </td>
                                                    <td><asp:Label ID="lblError2" runat="server" Font-Bold="True" ForeColor="Red" EnableViewState="false"></asp:Label></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <table style="border-spacing: 0px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TXT_ACCNO" runat="server"  Enabled="False" ReadOnly="True" CssClass="ASPTextBox" Width="200px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TXT_ACCNAMA" runat="server"  Enabled="False" ReadOnly="True" CssClass="ASPTextBox" Width="200px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="DDL_ACCBANK" runat="server" Enabled="False" CssClass="ASPDropDownList">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <td>
                                ...
                                <asp:Button runat="server" ID="CPStatus" CssClass="ASPButton" Height="30px" Font-Size="14px" BackColor="White" Text="Loading Status CP" OnClick="BT_CP_Click"/>
                                <asp:Button runat="server" ID="BT_CP" CssClass="ASPButton" Height="30px" Font-Size="14px" Font-Bold="True" Text="CLINICAL PATHWAY LIST" OnClick="BT_CP_LIST" />
                                <hr />
                                <div id="DV_WARNING" runat="server" style="padding:15px;border:2px solid red" visible="false">
                            ...
                            <td style="text-align: left" colspan="2">
                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <table id="TBL_PROVIDER" runat="server" visible="false" style="background-color: green; border-spacing: 0px;">
                                            <tr>
                                                <td>
                                                    <table style="border-spacing: 0px;">
                                                        <tr>
                                                            <td style="font-weight: bold; color: white; width: 120px;"><strong>NAMA PROVIDER</strong></td>
                                                            <td class="auto-style4">
                                                                <asp:TextBox ID="TXT_NAMA_PROVIDER" runat="server" CssClass="ASPTextBox" Width="300px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-weight: bold; color: white; width: 120px;">STATUS</td>
                                                            <td>
