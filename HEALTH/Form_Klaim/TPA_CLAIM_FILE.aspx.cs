...
namespace HEALTH.Form_Klaim
{
    public partial class TPA_CLAIM_FILE : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
			...
			// Save Type (Header / Detail)
            if (LB_TIPE.Text != "D")
            {
                BT_SAVE_DETAIL.Visible = false;
            }
            else {
        ...
        protected void BT_SAVE_Click(object sender, EventArgs e)
        {
            ...
            ////{
            ////    if(LB_TPA.Text == "04"){
            ////        conn.QueryString = "exec SP_CLM_TPA_CLAIM_BENEFIT_INSERT_HALODOC '" + LB_BATCH.Text + "'";
            ...
            try
            {
                conn.QueryString = "exec SP_CLM_TPA_UNPROCESS_BYBATCH '" + LB_TPA.Text + "', '" + LB_BATCH.Text + "'";
		...
		protected void BT_SAVE_DETAIL_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < DGR.Items.Count; i++)
            {
                TextBox TXT01 = (TextBox)DGR.Items[i].FindControl("TXT01");
                ...
                conn.QueryString = "update TPA_CLAIM_DETAIL set " +
                                    "F01 = '" + TXT01.Text.Trim().Replace("'", "`") + "', " +
                                    "F02 = '" + TXT02.Text.Trim().Replace("'", "`") + "', " +
                                    "F03 = '" + TXT03.Text.Trim().Replace("'", "`") + "', " +
                                    "F04 = '" + TXT04.Text.Trim().Replace("'", "`") + "', " +
