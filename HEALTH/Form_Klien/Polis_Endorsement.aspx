<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Polis_Endorsement.aspx.cs" Inherits="HEALTH.Form_Klien.Polis_Endorsement" %>
        ...
        <table style="position: absolute; top: 0px; left: 0px; width: 100%; border-spacing: 0px;">
                ...
                <td>
                    <table style="border-spacing:0px;">
                        ...
                        <tr>
                            ...
                            &nbsp;<asp:Button ID="BT_NEW" runat="server" CssClass="ASPButton" OnClick="BT_NEW_Click" Text="REGISTRASI ENDORSEMENT BARU" Font-Bold="True" ForeColor="Blue" Height="20px" />
                            </td>
                        </tr>
                    </table>
            ...
            <tr  id="TR3" runat="server" visible="false">
                <td>
                    <table style="border-spacing:0px;">
                        <tr>
                            <td style="width:100px;">POLIS</td>
                            <td>
                                <asp:DropDownList ID="DDL_POLICY" runat="server" AutoPostBack="True" CssClass="ASPDropDownList" OnSelectedIndexChanged="DDL_POLICY_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:TextBox ID="TXT_POLICYSEARCH" runat="server" BackColor="#FFFF66" CssClass="ASPTextBox" Width="121px"></asp:TextBox>
                                <asp:Button ID="BT_POLICYSEARCH" runat="server" BackColor="Yellow" CssClass="ASPButton" Font-Bold="True" OnClick="BT_POLICYSEARCH_Click" Text="!" ToolTip="S" />
                            </td>
                        </tr>
                        <tr>
                            <td>PERIODE</td>
                            <td>
                                <asp:DropDownList ID="DDL_PERIOD" runat="server" CssClass="ASPDropDownList">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <asp:Label ID="LB_ERRORSUBMIT" runat="server" Font-Bold="True" CssClass="ASPLabel" ForeColor="Red"></asp:Label>
                </td>
            </tr>
        </table>
    </form>
