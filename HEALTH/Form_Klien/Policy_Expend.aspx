<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Policy_Expend.aspx.cs" Inherits="HEALTH.Form_Klien.Policy_Expend" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <td>
                    <table style="border-spacing: 0px;">
                                    ...
                                    <tr>
                                        <td>COMPANY NAME&nbsp;&nbsp;</td>
                                        <td>
                                            <asp:TextBox ID="TXT_COMPANY" runat="server" MaxLength="50" Width="100%" CssClass="ASPTextBox"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100px;">EXPENDED?</td>
                                        <td>
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="NO POLIS">
                                <ItemTemplate>
                                    ...
                                    &nbsp;<asp:Button ID="BT_QUOTATION" runat="server" BackColor="Blue" CssClass="ASPButton" Font-Bold="True" ForeColor="White" Text="H" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:BoundColumn DataField="PERSENCADUJROH" HeaderText="% CADANGAN UJROH">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" ForeColor="#6600FF" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="KONTRIBUSI" HeaderText="KONTRIBUSI">
                            ...
                            <asp:BoundColumn DataField="CADANGAN_UJROH" HeaderText="CADANGAN UJROH">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" ForeColor="Green" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="USED_CADANGAN_UJROH" HeaderText="CADANGAN UJROH TERPAKAI">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                            ...
                            <asp:BoundColumn DataField="SISA_CADANGAN_UJROH" HeaderText="SISA CADANGAN UJROH">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
        ...
        <div style="background-color: transparent !important; opacity: 0.9;">
            <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="230px" Width="415px" Style="z-index: 111; background-color: White; position: fixed; left: 100px; top: 12%; border: outset 2px gray; padding: 5px; display: none">
                <table style="border-spacing: 0px; width: 100%;">
                    <tr>
                        <td bgcolor="#CCCCCC" style="border-style: outset; text-align: center">
                            <asp:Label ID="LB_TITLE" runat="server" Font-Bold="True" Font-Size="Small" Text="EXPEND UJRAH RESERVE REQUEST"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                                    ...
                                    <td>
                                        <table style="border-spacing: 0px; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="TXT_CAIR" runat="server" Text="" CssClass="ASPTextBoxNumber" Width="30%" Font-Bold="true" onkeypress="return CheckNumeric();" BackColor="Yellow"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>ACCOUNT NO</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="TXT_ACCNO" runat="server" Text=""  MaxLength="50" Width="50%" CssClass="ASPTextBox" Font-Bold="true" onkeypress="return CheckNumeric();" BackColor="Yellow"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>ACCOUNT NAME</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="TXT_ACCNAME" runat="server" Text="" MaxLength="255" Width="80%" CssClass="ASPTextBox" Font-Bold="true" BackColor="Yellow"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>BANK</td>
