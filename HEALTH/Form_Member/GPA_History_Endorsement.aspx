<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GPA_History_Endorsement.aspx.cs" Inherits="HEALTH.Form_Member.GPA_History_Endorsement" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DDL_STATUS" runat="server" CssClass="ASPDropDownList">
                                    ...
                                    <asp:ListItem Value="0">BATAL REGISTER</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="TXT_DATE_STATUS1" runat="server" CssClass="ASPTextBox"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="ceDateStat1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_DATE_STATUS1">
                                        </ajaxToolkit:CalendarExtender>
                                        &nbsp;-
                                                    <asp:TextBox ID="TXT_DATE_STATUS2" runat="server" CssClass="ASPTextBox"></asp:TextBox>
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_DATE_STATUS2">
                                        </ajaxToolkit:CalendarExtender>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
