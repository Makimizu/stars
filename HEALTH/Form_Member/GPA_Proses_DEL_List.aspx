<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GPA_Proses_DEL_List.aspx.cs" Inherits="HEALTH.Form_Member.GPA_Peserta_Deletion_List" %>
...
<body>
    <form id="form1" runat="server">
        <table style="position: absolute; top: 0px; left: 0px; width: 100%;">
			...
			<tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Visible="True">Catatan:</asp:Label>
                    <asp:Label ID="LB_STATUS_BIAYA_DEL" runat="server" Font-Bold="True" Visible="True"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan"
                        ...
                        CssClass="ASPDatagrid" AutoGenerateColumns="False" ShowFooter="True" OnItemDataBound="DGR_ItemDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="TGL KELUAR" HeaderText="TGL KELUAR">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="MASA KEPESERTAAN" HeaderText="MASA&lt;BR&gt;KEPESERTAAN">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                            </asp:BoundColumn>
