<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PesertaInfo.aspx.cs" Inherits="HEALTH.Form_Member.PesertaInfo" %>
                        ...
                        <tr style="vertical-align: top;">
                            <td>
                                <table style="border-spacing: 0px;">
                                                ...
                                                <tr style="vertical-align: top;">
                                                    ...
                                                    <td>
                                                        <table style="border: 1px solid grey; border-collapse: collapse;" border="1">
                                                            ...
                                                            <tr>
                                                                <td><asp:Label ID="Label24" runat="server" Text="NO KARTU TPA" CssClass="ASPLabel" ></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="LB_NO_KARTU" runat="server" CssClass="ASPLabel" Font-Bold="True" ></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td><asp:Label ID="Label25" runat="server" Text="TPA" CssClass="ASPLabel" ></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="LB_TPA_DESC" runat="server" CssClass="ASPLabel" Font-Bold="True" ></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label23" runat="server" CssClass="ASPLabel" Font-Bold="True" Font-Underline="True" Text="PERIODE KEPESERTAAN"></asp:Label><br />
                                            <asp:ListBox ID="DDL_PERIOD" runat="server" CssClass="ASPDropDownList" Height="50px" OnSelectedIndexChanged="DDL_PERIOD_SelectedIndexChanged" Width="300px"></asp:ListBox>
                    ...
                    <table style="width: 100%; border-spacing: 0px;">
                        <tr>
                            <td style="width: 16%; text-align: center;">
                                <asp:Button ID="BT_5c" runat="server" CssClass="ASPButton" Font-Bold="False" Text="POLICY T &amp; C" Width="100%" OnClick="BT_5c_Click" />
                            </td>
                            <td style="width: 16%; text-align: center;">
                                <asp:Button ID="BT_5d" runat="server" CssClass="ASPButton" Font-Bold="False" Text="POLICY BENEFIT" Width="100%" OnClick="BT_5d_Click" />
                            </td>
                            <td style="width: 16%; text-align: center;">
                                <asp:Button ID="BT_5b" runat="server" CssClass="ASPButton" Font-Bold="False" Text="BENEFIT USAGE" Width="100%" OnClick="BT_5b_Click" />
                            </td>
                            <td style="width: 16%; text-align: center;">
                                <asp:Button ID="BT_5" runat="server" CssClass="ASPButton" Font-Bold="False" Text="CLAIM HISTORY" Width="100%" OnClick="BT_5_Click" />
                            </td>
                            <td style="width: 16%; text-align: center;">
                                <asp:Button ID="BT_5a" runat="server" CssClass="ASPButton" Font-Bold="False" Text="CLAIM TRANSACTION" Width="100%" OnClick="BT_5a_Click" />
                            </td>
                            <td style="width: 16%; text-align: center;">
                                <asp:Button ID="BT_6" runat="server" CssClass="ASPButton" Font-Bold="False" Text="PREMIUM" Width="100%" OnClick="BT_6_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
