...
{
    public partial class GPA_Peserta_ReprintCard : System.Web.UI.Page
    {
        ...
        protected void BT_ADD_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                conn.QueryString = "exec SP_GPA_PESERTA_REPRINT_CARD_PROSES " +
                                    "'" + LB_ID.Text + "'," +
            ...
            Response.Write("<script language='javascript'>parent.gparpcbody.location.href = '../Form_Member/GPA_Proses_RPC_List.aspx?BATCH_ID=" + LB_ID.Text + "';</script>");
            Response.Write("<script language='javascript'>parent.gparpcheader.location.href = '../Form_Member/GPA_Proses_RPC.aspx?BATCH_ID=" + LB_ID.Text + "';</script>");
        }
        ...
        private void ProcessFile(string fullpath, string filename)
        {
            ...
            con.Open();
            OleDbDataAdapter da = new OleDbDataAdapter("select REGNO from [PESERTA_REPRINT_CARD$] where REGNO<>''", con);
