<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PesertaInfo_CLAIMBENEFIT.aspx.cs" Inherits="HEALTH.Form_Member.PesertaInfo_CLAIMBENEFIT" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR_CLAIMBENEFIT" runat="server" CellPadding="3" PageSize="20" GridLines="Vertical" CssClass="ASPDatagrid" BorderColor="#999999" BackColor="White" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="BEN_AWAL" HeaderText="BENEFIT AWAL">
                            ...
                            <asp:BoundColumn DataField="AMOUNT_UNPAID" HeaderText="TOLAK">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                            ...
                            <asp:BoundColumn DataField="BEN_SISA" HeaderText="BENEFIT SISA">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" />
                            </asp:BoundColumn>
                        </Columns>
