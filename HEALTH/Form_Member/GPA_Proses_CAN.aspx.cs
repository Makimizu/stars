...
{
    public partial class GPA_Proses_CAN : System.Web.UI.Page
    {
        ...
        protected void BT_UPLOAD_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("<script language='javascript'>parent.gpadelbody.location.href = '../Form_Member/GPA_Proses_CAN_List.aspx?BATCH_ID=" + LB_ID.Text + "';</script>");
            Response.Write("<script language='javascript'>parent.gpadelheader.location.href = '../Form_Member/GPA_Proses_CAN.aspx?BATCH_ID=" + LB_ID.Text + "';</script>");
        ...
        private void ProcessFile(string fullpath, string filename)
        {
            ...
            con.Open();
            OleDbDataAdapter da = new OleDbDataAdapter("select REGNO, from [PESERTA_KELUAR$] where REGNO<>''", con);
            ...
            foreach (DataRow myRow in dt.Rows)
            {
                ...
                conn.QueryString = "exec SP_GPA_PESERTA_CANCEL_PROSES " +
                                    "'" + LB_ID.Text + "'," +
                                    "'" + regno + "'," +
        ...
        protected void BT_ADD_Click(object sender, EventArgs e)
        {
            ...
            FillDDLREGNO();
            ClientScript.RegisterStartupScript(GetType(), "", "<script language='javascript'>parent.gpacanbody.location.href = '../Form_Member/GPA_Proses_CAN_List.aspx?BATCH_ID=" + LB_ID.Text + "';</script>");
        }
    }
}