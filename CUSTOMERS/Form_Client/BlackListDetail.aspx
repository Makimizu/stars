<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlackListDetail.aspx.cs" Inherits="CUSTOMERS.Form_Client.BlackListDetail" %>
                ...
                <td style="width: 50%;">
                    <table style="border-spacing: 0px; width: 100%;">
                        ...
                        <tr>
                            <td>JOB</td>
                            <td>
                                <asp:TextBox ID="TXT_JOB" runat="server" MaxLength="100" Width="90%" Style="text-transform: uppercase;" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>RELIGION</td>
                            <td>
                                <asp:TextBox ID="TXT_RELIGION" runat="server" MaxLength="100" Width="90%" Style="text-transform: uppercase;" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>MARITAL STATUS</td>
                            <td>
                                <asp:TextBox ID="TXT_MARITAL" runat="server" MaxLength="100" Width="90%" Style="text-transform: uppercase;" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>ID TYPE</td>
                            <td>
                                <asp:TextBox ID="TXT_IDTYPE" runat="server" MaxLength="100" Width="90%" Style="text-transform: uppercase;" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>ID NO.</td>
                ...
                <td style="width: 50%;">
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TXT_CITIZENSHIP" runat="server" MaxLength="100" Width="90%" Style="text-transform: uppercase;" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>PHONE 1</td>
                        ...
                        <tr>
                            <td>PROVINCE</td>
                            <td>
                                <asp:TextBox ID="TXT_PROVINCE" runat="server" MaxLength="100" Width="90%" Style="text-transform: uppercase;" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>COUNTRY</td>
                            <td>
                                <asp:TextBox ID="TXT_COUNTRY" runat="server" MaxLength="100" Width="90%" Style="text-transform: uppercase;" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>ZIP CODE</td>
                            <td>
                                <asp:TextBox ID="TXT_ZIPCODE" runat="server" MaxLength="15" Width="90%" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>EDUCATION</td>
                            <td>
                                <asp:TextBox ID="TXT_EDUCATION" runat="server" MaxLength="50" Width="90%" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>BLACKLIST FLAG</td>
                            <td>
                                <asp:DropDownList ID="DDL_FLAG" runat="server" CssClass="ASPDropDownList"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>SOURCE</td>
                        ...
                        <tr>
                            <td>REMARK</td>
                            <td>
                                <asp:TextBox ID="TXT_REMARK" runat="server" MaxLength="255" Width="90%" CssClass="ASPTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <iframe id="frm1" runat="server" width="93%" ></iframe>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
