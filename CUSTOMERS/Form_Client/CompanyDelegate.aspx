<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyDelegate.aspx.cs" Inherits="CUSTOMERS.Form_Client.CompanyDelegate" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:DataGrid ID="DGR" runat="server" CellPadding="4" PageSize="20"
                            ...
                            AllowPaging="True" AutoGenerateColumns="False" CssClass="ASPDatagrid" GridLines="None" ForeColor="#333333" OnItemCommand="DGR_ItemCommand">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="AGENT" HeaderText="KODE AGEN"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="AGENT_START_DATE" HeaderText="TGL EFEKTIF"></asp:BoundColumn>
                                ...
                                <asp:TemplateColumn>
                                    <ItemTemplate>
                                        <asp:Button ID="BT_SET" runat="server" BackColor="Blue" CommandName="Set" CssClass="ASPButton" Font-Bold="True" ForeColor="White" Text="SET" />
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
