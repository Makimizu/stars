<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agent_Entry.aspx.cs" Inherits="SALESMARKET.Form_Agents.Agent_Entry" %>
            ...
            <tr>
                <td>
                    <table style="border-spacing: 0px;">
                        ...
                        <tr>
                            <td class="auto-style5">FRONT NAME</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TXT_PHONE" runat="server" CssClass="ASPTextBox" MaxLength="100" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style5">EMAIL</td>
                            <td>
                                <asp:TextBox ID="TXT_EMAIL" runat="server" CssClass="ASPTextBox" MaxLength="255" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style5">UPLINER</td>
                            <td>
