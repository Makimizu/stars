<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Header.aspx.cs" Inherits="REAS.Standard.Header" %>
        ...
        <table style="width: 100%; top: 0px; left: 0px; position: absolute;">
            <tr>
                ...
                <td style="text-align: right;">
                    ...
                    &nbsp;<a href="javascript:" onclick="window.open('main.aspx');" target="_blank"><B style="color: #FFFF00; font-size:x-small">NEW TAB</B></a>
                    <br />
