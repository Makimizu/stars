    ...
    public partial class Header : System.Web.UI.Page
    {
        ...
        protected void Authenticate()
        {
            try
            {
                ...
                //string errorMessage = "Session is : " + session + "//"; // Escape single quotes
                //Response.Write("<script language='javascript'>alert('" + errorMessage + "');</script>"); Console.WriteLine(session);
            ...
            {
                //LBL_USER.Text = "Aditya R Permana (Vendor Kazokku)";
        ...
        protected void Logout()
        {
            ...
            conn.QueryString = "select URL = (case when APP_SVR like 'https://%' then '' else 'http://' end) + APP_SVR + '/' + APP_PATH + '/' from M_APPS where CODE='0'";
            conn.ExecuteQuery();
        ...
        protected void LB_PASSWORD_Click(object sender, EventArgs e)
        {
            ...
            string linkAction = GlobalUse.PopupCenterWindow("../../GO/ChangePassword.aspx?s=" + LB_SES.Text, "Change_Password", 400, 300);
