...
namespace REAS.Form_Company
{
    public partial class Company : System.Web.UI.Page
    {
        ...
        protected void LoadRecord(string code)
        {
            ...
            TXT_BANKNAME.Text = conn.GetFieldValue("BANK_NAME").ToString();
            TXT_BANK_ACCOUNTNO.Text = conn.GetFieldValue("BANK_ACCOUNTNO").ToString();
            TXT_ACCOUNT_NAME.Text = conn.GetFieldValue("BANK_ACCOUNT_NAME").ToString();
            TXT_BANCH.Text = conn.GetFieldValue("BANK_BRANCH").ToString();
            TXT_SWIFTCODE.Text = conn.GetFieldValue("SWIFTCODE").ToString();
        ...
        protected void BT_SAVE_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                conn.QueryString = "exec SP_COMPANY_UPSERT " +
                                    ...
                                    "'" + TXT_BANKNAME.Text.Trim() + "'," +
                                    "'" + TXT_BANK_ACCOUNTNO.Text.Trim() + "'," +
                                    "'" + TXT_SWIFTCODE.Text.Trim() + "'," +
                                    "'" + TXT_ACCOUNT_NAME.Text.Trim() + "'," +
                                    "'" + TXT_BANCH.Text.Trim() + "'";
                conn.ExecuteQuery();
