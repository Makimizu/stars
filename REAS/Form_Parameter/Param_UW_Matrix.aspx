<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Param_UW_Matrix.aspx.cs" Inherits="REAS.Form_Parameter.Param_UW_Matrix" %>
        ...
        <table style="width: 100%; left: 0px; top: 0px; border-spacing: 0px;">
            <tr>
                ...
                <td style="vertical-align: top; width: 100%;">
                    ...
                    <asp:DataGrid ID="DGR_UW" runat="server" CssClass="ASPDatagrid" OnItemCommand="DGR_LIST_ItemCommand" BackColor="White" BorderColor="#999999" BorderWidth="1px" CellPadding="3" GridLines="Vertical" BorderStyle="None">
