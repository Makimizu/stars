...
{
    public partial class UploadLanjutanFinSettlementIndividu : System.Web.UI.Page
    {
        ...
        {
            LBL_TITLE.Text = "Upload Lanjutan Fin Settlement Health Individual";
                    ...
                    using (var package = new ExcelPackage(new FileInfo(filePath)))
                    {
                        ...
                        for (int row = 2; row <= worksheet.Dimension.End.Row; row++)
                        {
                            if (DDL_TYPE.SelectedValue == "contribution_reas")
                            {
                                ...
                                query = "UPDATE [AutoReportReconcile].[dbo].[RptContributionIndividual] SET Status = 'Settlement'  WHERE ID = '" + ID + "'";
                            ...
                            else if (DDL_TYPE.SelectedValue == "claim_reas")
                            {
                                ...
                                query = "UPDATE [AutoReportReconcile].[dbo].[RptClaimIndividual] SET Status = 'Payment'  WHERE ID = '" + ID + "'";
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            if (DDL_TYPE.SelectedValue != "")
            {
                ...
                {
                    fileName = "Upload Payment Reas Contribution.xlsx";  // Nama file yang akan diunduh
                }
                else if (DDL_TYPE.SelectedValue == "claim_individual")
                {
                    fileName = "Upload Payment Reas Claim.xlsx";  // Nama file yang akan diunduh
                }
            }
