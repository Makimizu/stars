<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimList.aspx.cs" Inherits="REAS.Form_App.ClaimList" %>
                            ...
                            <td style="width: 50%;">
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        <td>OCCURED DATE</td>
                                        <td>
                                            <asp:TextBox ID="TXT_OCCUREDDATE1" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="ceDate1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_OCCUREDDATE1">
                                            </ajaxToolkit:CalendarExtender>
                                            &nbsp;-&nbsp;
                                            <asp:TextBox ID="TXT_OCCUREDDATE2" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_OCCUREDDATE2">
                                            </ajaxToolkit:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="REINS_CODE" Visible="False"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="PERIOD" HeaderText="PERIOD ACTIVE">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="OCCURED_DATE" HeaderText="OCCURED DATE">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" Width="80px" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="SHARE_AMOUNT" HeaderText="SHARE AMOUNT">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" ForeColor="Blue" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="REINS_NAME" HeaderText="REINSURANCE"></asp:BoundColumn>
                        </Columns>
