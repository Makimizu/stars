<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadTechnicalReas.aspx.cs" Inherits="REAS.Form_App.UploadTechnicalReas" %>
                ...
                <div>
                    <asp:GridView ID="GV_UploadedData" runat="server" AutoGenerateColumns="False" CssClass="table" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CellSpacing="2" Style="width: 100%">
                        <Columns>
                            ...
                            <asp:BoundField DataField="JOURNAL_NO" HeaderText="JOURNAL NO" SortExpression="JOURNAL ND" />
