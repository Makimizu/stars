<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ValidasiReportReasGLIFE.aspx.cs" Inherits="REAS.Form_App.ValidasiReportReasGLIFE" %>
        ...
        <div id="modal" class="modal" style="display:none;">
           <div class="modal-content">
                ...
                <div>
                    <asp:GridView ID="GV_UploadedData" runat="server" AutoGenerateColumns="False" CssClass="table" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CellSpacing="2" Style="width: 100%">
                        <Columns>
                            ...
                            <asp:BoundField DataField="REAS_NAME" HeaderText="REAS NAME" SortExpression="REAS NAME" />
                ...
                <div class="modal-buttons">
                    ...
                    <asp:Button ID="btnCancel" runat="server" CssClass="btn-cancel" Text="Close" OnClick="btnCancel_Click" />
                </div>
            </div>
        </div>
                ...
                <td>
                    <table style="border-spacing: 6px;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TXT_UPDATEDATE" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;" Enabled="false" Font-Size="12px"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="ceUpdateDate" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_UPDATEDATE">
                                </ajaxToolkit:CalendarExtender>
                            </td>
                        </tr>
                        <tr>
                            <td>RPT GLIFE REAS TYPE <b>*</b></td>
                            <td>
                                <asp:DropDownList ID="DDL_TYPE" runat="server" AutoPostBack="false" CssClass="ASPDropDownList" 
                                    ...
                                    <asp:ListItem Value="refund">Glife - Refund Reas</asp:ListItem>
                                    <asp:ListItem Value="claim">Glife - Claim Reas</asp:ListItem>
                                    <asp:ListItem Value="contribution_gtlr">Glife - Contribution GTLR Reas</asp:ListItem>
                                    <asp:ListItem Value="contribution_non_gtlr">Glife - Contribution Non GTLR Reas</asp:ListItem>
                                    <asp:ListItem Value="contribution_renewal">Glife - Contribution Renewal Reas</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            <td>TEMPLATE FILE</td>
                            <td>
                                <asp:LinkButton ID="LBT_TEMPLATE" runat="server" Text="DOWNLOAD" OnClick="LBT_TEMPLATE_Click" Font-Size="12px"></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td>UPLOAD FILE</td>
