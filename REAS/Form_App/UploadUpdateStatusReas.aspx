<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadUpdateStatusReas.aspx.cs" Inherits="REAS.Form_App.UploadUpdateStatusReas" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DDL_TYPE" runat="server" AutoPostBack="false" CssClass="ASPDropDownList" 
                                    ...
                                    <asp:ListItem Value="glife_individual">GLIFE</asp:ListItem>
                                </asp:DropDownList>
