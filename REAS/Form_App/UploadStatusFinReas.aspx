<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadStatusFinReas.aspx.cs" Inherits="REAS.Form_App.UploadStatusFinReas" %>
                ...
                <td>
                    <table style="border-spacing: 6px;">
                        ...
                        <tr>
                            <td>MEMO TYPE <b>*</b></td>
                            <td>
                                <asp:DropDownList ID="DDL_TYPE_MEMO" runat="server" AutoPostBack="true" CssClass="ASPDropDownList" 
                                    OnSelectedIndexChanged="DDL_TYPE_MEMO_SelectedIndexChanged" Width="200px">
                        ...
                        <tr>
                            <td style="width: 100px;">MEMO NO</td>
                            <td>
                                <asp:TextBox ID="TXT_DESCRIPTION" runat="server" CssClass="ASPTextBox" Width="200px" OnTextChanged="TXT_DESCRIPTION_TextChanged"></asp:TextBox>
                            </td>
                             <td>
                                <asp:Button ID="BTN_CHECKMEMO" runat="server" CssClass="ASPButton" OnClick="BTN_CHECKMEMO_Click" Text="CHECK MEMO" />
                            </td>
                        </tr>
                        
                        <tr>
                            <td style="width: 100px;"><asp:Label ID="LBL_AMOUNT_REAS" runat="server">AMOUNT REAS</asp:Label></td>
                            <td>
                                <asp:TextBox ID="TXT_AMOUNT_REAS" runat="server" CssClass="ASPTextBox" Width="200px" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 100px;"><asp:Label ID="LBL_ACTUAL_AMOUNT_REAS" runat="server">ACTUAL AMOUNT REAS</asp:Label></td>
                            <td>
                                <asp:TextBox ID="TXT_ACTUAL_AMOUNT_REAS" runat="server" CssClass="ASPTextBox" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>UPLOAD FILE</td>
                            <td>
                                <asp:FileUpload ID="TXT_FILE_UPLOAD" runat="server" class="ASPTextBox" AllowMultiple="true"/>
                        </td>
                        </tr>
                        <tr>
                            <td></td>
