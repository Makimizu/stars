<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFinSettlementGLIFE.aspx.cs" Inherits="REAS.Form_App.UploadFinSettlementGLIFE" %>
                ...
                <div>
                    <asp:GridView ID="GV_UploadedData" runat="server" AutoGenerateColumns="False" CssClass="table" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CellSpacing="2" Style="width: 100%">
                        <Columns>
                            ...
                            <asp:BoundField DataField="JOURNAL_NO" HeaderText="JOURNAL NO" SortExpression="JOURNAL NO" />
                            <asp:BoundField DataField="POLICY_NO" HeaderText="POLICY NO / REGNO" SortExpression="POLICY NO / REGNO" />
                            <asp:BoundField DataField="LAST_TECHNICAL_DATE" HeaderText="LAST TECHNICAL DATE" SortExpression="LAST TECHNICAL DATE" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DDL_TYPE" runat="server" AutoPostBack="true" CssClass="ASPDropDownList" 
                                    ...
                                    <asp:ListItem Value="contribution_gtlr">CONTRIBUTION GTLR</asp:ListItem>
                                    <asp:ListItem Value="contribution_non_gtlr">CONTRIBUTION NON GTLR</asp:ListItem>
                                    <asp:ListItem Value="contribution_renewal">CONTRIBUTION RENEWAL</asp:ListItem>
                                    <asp:ListItem Value="refund">REFUND</asp:ListItem>
                                    <asp:ListItem Value="claim_glife">CLAIM</asp:ListItem>
                                </asp:DropDownList>
