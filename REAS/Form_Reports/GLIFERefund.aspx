<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLIFERefund.aspx.cs" Inherits="REAS.Form_Reports.GLIFERefund" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <asp:BoundColumn DataField="ID" HeaderText="ID">
                            <ItemStyle Font-Bold="True" ForeColor="Green" HorizontalAlign="Left" />
                        </asp:BoundColumn>
