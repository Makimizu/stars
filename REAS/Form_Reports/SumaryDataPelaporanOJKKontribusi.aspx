<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SumaryDataPelaporanOJKKontribusi.aspx.cs" Inherits="REAS.Form_Reports.SumaryDataPelaporanOJKKontribusi" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                          <%--  <asp:BoundColumn DataField="NO_POLIS" HeaderText="NO_POLIS" FooterStyle-Font-Bold="true">
                            ...
                            <asp:BoundColumn DataField="UJROH_RE" HeaderText="UJROH RE"  DataFormatString="{0:N2}">
                            ...
                            <asp:BoundColumn DataField="TABARRU_RE" HeaderText="TABARRU RE"   DataFormatString="{0:N2}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="TOTAL_KONTRIBUSI" HeaderText="TOTAL KONTRIBUSI"   DataFormatString="{0:N2}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Green" HorizontalAlign="Right" />
                            </asp:BoundColumn>
