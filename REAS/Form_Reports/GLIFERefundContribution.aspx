<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLIFERefundContribution.aspx.cs" Inherits="REAS.Form_Reports.GLIFERefundContribution" %>
...
<body>
    ...
    <asp:BoundColumn DataField="FAMILIY_REL" HeaderText="FAMILIY REL" />
    ...
    <asp:BoundColumn DataField="FREQ" HeaderText="FREQ" />
    ...
    <asp:BoundColumn DataField="FINANCE_DOC_NO" HeaderText="FINANCE DOC NO" />
    ...
    <asp:BoundColumn DataField="AGING_FIN_SETTLE" HeaderText="AGING FIN SETTLE" />
