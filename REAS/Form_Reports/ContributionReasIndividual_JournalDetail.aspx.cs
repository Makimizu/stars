...
{
    public partial class ContributionReasIndividual_JournalDetail : System.Web.UI.Page
    {
        ...
        private double totalAmountTabarru = 0;
        private double totalAmountUjroh = 0;
        ...
        protected void FillDGR(int pageNumbers)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("[dbo].[SP_RTF_GET_CONTRIBUTIONINDIVIDUAL_DATA_JOURNALDETAIL]", connect))
            {
                if (ReasName == null)
                {
                    ReasName = "";
                ...
                try
                {
                    ...
                    totalAmountTabarru = Convert.ToDouble(ds.Tables[0].Rows[0][1]);
                    totalAmountUjroh = Convert.ToDouble(ds.Tables[0].Rows[0][2]);
                    ...
                    ViewState["TotalAmountTabarru"] = totalAmountTabarru;
                    ViewState["TotalAmountUjroh"] = totalAmountUjroh;

                    LB_RESULT.Text = "Total Data : " + totalRows.ToString() + " Records";
                    LB_RESULT2.Text = "Total Amount Tabarru : Rp. " + totalAmountTabarru.ToString();
                    LB_RESULT3.Text = "Total Amount Ujroh : Rp. " + totalAmountUjroh.ToString();
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            string outputFolderFile = Path.Combine(baseDir, "Reports\\Backup", DateTime.Now.ToString("yyyyMM"), "Journal_Contribution_INDIVIDUAL_" + period + ".xlsx");
            ...
            if (File.Exists(outputFolderFile))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=" + "Journal_Contribution_INDIVIDUAL_" + period + ".xlsx");
