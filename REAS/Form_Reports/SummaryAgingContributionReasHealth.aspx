<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryAgingContributionReasHealth.aspx.cs" Inherits="REAS.Form_Reports.SummaryAgingContributionReasHealth" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AGE_REG" HeaderText="AGE REG" DataFormatString="{0:N0}"  />
                            ...
                            <asp:BoundColumn DataField="TABARRU_FULL" HeaderText="TABARRU FULL (NET SETELAH DISC)" />
