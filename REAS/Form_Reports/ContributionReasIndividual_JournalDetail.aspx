<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContributionReasIndividual_JournalDetail.aspx.cs" Inherits="REAS.Form_Reports.ContributionReasIndividual_JournalDetail" %>
        ...
        <table style="position: absolute; top: 0px; left: 0px; border-spacing: 0px;">
            ...
            <tr>
                <td>
                    ...
                    <br />
                    <asp:Label ID="LB_RESULT3" runat="server" Font-Size="11px" Font-Bold="false"></asp:Label>
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AMOUNT_TABARRU" HeaderText="TABARRU RE" >
                            ...
                            <asp:BoundColumn DataField="AMOUNT_UJROH" HeaderText="UJROH RE" >
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Blue" HorizontalAlign="Right" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="AMOUNT_CONTRIBUTION" HeaderText="TABARRU RE + UJROH RE" >
                                 <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Blue" HorizontalAlign="Right" />
                            </asp:BoundColumn>
