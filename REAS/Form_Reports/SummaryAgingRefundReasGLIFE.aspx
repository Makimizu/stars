<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryAgingRefundReasGLIFE.aspx.cs" Inherits="REAS.Form_Reports.SummaryAgingRefundReasGLIFE" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="TGL_PELUNASAN" HeaderText="TGL PELUNASAN"  DataFormatString="{0:dd MMM yyyy}" />
                            ...
                            <asp:BoundColumn DataField="NP_TREATY_DESCR" HeaderText="NP TREATY DESCR" />
