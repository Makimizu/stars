<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimReasIndividual.aspx.cs" Inherits="REAS.Form_Reports.ClaimReasIndividual" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="TIPE_STATUS" HeaderText="TIPE STATUS" />
                            <asp:BoundColumn DataField="REGISTERED_DATE" HeaderText="REGISTERED DATE" DataFormatString="{0:dd MMM yyyy}"  />
                            <asp:BoundColumn DataField="APPROVED_DATE" HeaderText="APPROVED DATE" DataFormatString="{0:dd MMM yyyy}"  />
                            ...
                            <asp:BoundColumn DataField="TANGGAL_LAHIR" HeaderText="TANGGAL LAHIR" DataFormatString="{0:dd MMM yyyy}"  />
                            <asp:BoundColumn DataField="TANGGAL_MENINGGAL" HeaderText="TANGGAL MENINGGAL" DataFormatString="{0:dd MMM yyyy}"  />
                            ...
                            <asp:BoundColumn DataField="BEBAN_KLAIM_REAS" HeaderText="BEBAN KLAIM REAS"   />
                            <asp:BoundColumn DataField="KETERANGAN" HeaderText="KETERANGAN" />
                            <asp:BoundColumn DataField="AGREEMENT_DOC_NO" HeaderText="AGREEMENT DOC NO" />
                            <asp:BoundColumn DataField="AGREEMENT_DESCR" HeaderText="AGREEMENT DESCR" />
