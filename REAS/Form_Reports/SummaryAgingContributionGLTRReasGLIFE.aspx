<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryAgingContributionGLTRReasGLIFE.aspx.cs" Inherits="REAS.Form_Reports.SummaryAgingContributionGLTRReasGLIFE" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                       ...
                       <Columns>
                            ...
                            <asp:BoundColumn DataField="LAST_SETTLEMENT_DATE" HeaderText="LAST SETTLEMENT DATE" DataFormatString="{0:dd MMM yyyy}"  />
                            ...
                            <asp:BoundColumn DataField="NAMA_REAS_COMPANY" HeaderText="NAMA REAS COMPANY" />
                            <asp:BoundColumn DataField="AGREEMENT_QS" HeaderText="AGREEMENT QS" />
                            <asp:BoundColumn DataField="AGREEMENT_OR" HeaderText="AGREEMENT OR" />
                            <asp:BoundColumn DataField="PERSEN_SHARE_REAS_PPQS" HeaderText="PERSEN SHARE REAS PPQS" />
                            <asp:BoundColumn DataField="PERSEN_SHARE_REAS_PPS" HeaderText="PERSEN SHARE REAS PPS" />
                            <asp:BoundColumn DataField="PERSEN_SHARE_REAS_PPF" HeaderText="PERSEN SHARE REAS PPF" />
                            <asp:BoundColumn DataField="RATE_REAS" HeaderText="RATE REAS" />
                            <asp:BoundColumn DataField="PREMI_RE" HeaderText="PREMI RE" />
                            <asp:BoundColumn DataField="OWN_RETENTION" HeaderText="OWN RETENTION" />
                            <asp:BoundColumn DataField="AMOUNT_FACULTATIVE" HeaderText="AMOUNT FACULTATIVE" />
                            ...
                            <asp:BoundColumn DataField="NAMA_PASANGAN" HeaderText="NAMA PASANGAN" />
                            <asp:BoundColumn DataField="DOB_PASANGAN" HeaderText="DOB PASANGAN" DataFormatString="{0:dd MMM yyyy}" />
                            <asp:BoundColumn DataField="START_AGE_SPOUSE" HeaderText="START AGE SPOUSE" />
                            <asp:BoundColumn DataField="RATE_EM" HeaderText="RATE EM" />
                            <asp:BoundColumn DataField="RATE_EP" HeaderText="RATE EP" />
                            <asp:BoundColumn DataField="CHK_POL_TERM" HeaderText="CHK POL TERM" />
                            <asp:BoundColumn DataField="LAST_POL_ANNIV" HeaderText="LAST POL ANNIV" DataFormatString="{0:dd MMM yyyy}" />
                            <asp:BoundColumn DataField="POL_TERM_WHOLE_YR" HeaderText="POL TERM WHOLE YR" />
                            <asp:BoundColumn DataField="POL_TERM_WHOLE_MONTH" HeaderText="POL TERM WHOLE MONTH" />
                            <asp:BoundColumn DataField="LAST_END_OF_WHOLE_MONTH" HeaderText="LAST END OF WHOLE MONTH" DataFormatString="{0:dd MMM yyyy}" />
                            <asp:BoundColumn DataField="POL_TERM_WHOLE_DAY" HeaderText="POL TERM WHOLE DAY" />
                            <asp:BoundColumn DataField="POL_TERM_IN_MONTH" HeaderText="POL TERM IN MONTH" />
                            ...
                            <asp:BoundColumn DataField="RATE_DESCR" HeaderText="RATE DESCR" />
                            <asp:BoundColumn DataField="TENOR_CODE" HeaderText="TENOR CODE" />
                            <asp:BoundColumn DataField="RATE_FINAL" HeaderText="RATE FINAL" />
                            <asp:BoundColumn DataField="TOTAL_PCT_REAS_SHARE" HeaderText="TOTAL PCT REAS SHARE" />
                            ...
                            <asp:BoundColumn DataField="PCT_EM" HeaderText="PCT EM" />
                            <asp:BoundColumn DataField="KONTRIBUSI_EM" HeaderText="KONTRIBUSI EM" />
                            <asp:BoundColumn DataField="PCT_EP" HeaderText="PCT EP" />
                            ...
                            <asp:BoundColumn DataField="LINI_USAHA_OJK" HeaderText="LINI USAHA OJK" />
                            <asp:BoundColumn DataField="SUM_ASSURED" HeaderText="SUM ASSURED" />
                            <asp:BoundColumn DataField="SETORAN_BULANAN" HeaderText="SETORAN BULANAN" />
                            <asp:BoundColumn DataField="SALDO_TABUNGAN" HeaderText="SALDO TABUNGAN" />
