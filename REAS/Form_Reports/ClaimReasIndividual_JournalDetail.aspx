<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimReasIndividual_JournalDetail.aspx.cs" Inherits="REAS.Form_Reports.ClaimReasIndividual_JournalDetail" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AMOUNT" HeaderText="AMOUNT CLAIM" >
                                 <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Green" HorizontalAlign="Right" />
                            </asp:BoundColumn>
