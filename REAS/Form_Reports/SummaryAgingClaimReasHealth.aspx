<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SummaryAgingClaimReasHealth.aspx.cs" Inherits="REAS.Form_Reports.SummaryAgingClaimReasHealth" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="POLICY_START_DATE" HeaderText="POLICY START DATE" DataFormatString="{0:dd MMM yyyy}" />
                            <asp:BoundColumn DataField="POLICY_END_DATE" HeaderText="POLICY END DATE" DataFormatString="{0:dd MMM yyyy}"  />
                            ...
                            <asp:BoundColumn DataField="TIPE_CLAIM" HeaderText="TIPE CLAIM" />
                            ...
                            <asp:BoundColumn DataField="BENEFIT_DETAIL_CODE" HeaderText="BENEFIT CODE" />
                            <asp:BoundColumn DataField="BENEFIT_DETAIL_DESCR" HeaderText="BENEFIT DESCRIPTION" />
                            <asp:BoundColumn DataField="FREQ_UNIT" HeaderText="FREQ UNIT" />
                            <asp:BoundColumn DataField="FREQ" HeaderText="FREQ" DataFormatString="{0:N0}"  />
                            <asp:BoundColumn DataField="STATUS_DESCR" HeaderText="STATUS DESCRIPTION" />
                            <asp:BoundColumn DataField="ASO" HeaderText="IS ASO" />
                            <asp:BoundColumn DataField="TGL_RAWAT_DARI" HeaderText="TGL RAWAT DARI" DataFormatString="{0:dd MMM yyyy}"  />
                            <asp:BoundColumn DataField="TGL_RAWAT_SAMPAI" HeaderText="TGL RAWAT SAMPAI" DataFormatString="{0:dd MMM yyyy}"  />
                            <asp:BoundColumn DataField="FINANCE_DOCNO" HeaderText="FINANCE DOCNO" />
                            <asp:BoundColumn DataField="PAID" HeaderText="PAID"   />
                            <asp:BoundColumn DataField="CURR" HeaderText="CURRENCY" />
                            <asp:BoundColumn DataField="DIAGNOSA" HeaderText="DIAGNOSA" />
                            ...
                            <asp:BoundColumn DataField="BAGIAN_RETAKAFUL" HeaderText="BAGIAN RETAKAFUL"   />
