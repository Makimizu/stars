...
{
    public partial class SummaryAgingContributionReasHealth : System.Web.UI.Page
    {
        ...
        private void BindReasDropdown()
        {
            ...
            conn.QueryString = "SELECT [VALUE] AS ID, [VALUE] AS DESCR FROM [dbo].[RTF_PARAM_APPLICATION] WHERE APP_ID = 'RE' AND CODE = '0003'";
            conn.ExecuteQuery();
        ...
        protected void FillDGR(int pageNumbers)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("[dbo].[SP_RTF_GET_CONTRIBUTIONHEALTH_DATA]", connect))
            {
                ...
                cmd.Parameters.AddWithValue("@AGINGDAY", SelectedStatus);
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            string fileName = "Summary_Contribution_HEALTH_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
            ...
            using (ExcelPackage pck = new ExcelPackage())
            {
                ...
                ws.Cells["B1"].Value = ": Summary Aging Contribution Health";
