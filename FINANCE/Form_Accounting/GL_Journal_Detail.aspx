                                ...
                                <div style="width: 100%; height: 250px; overflow: auto;">
                                    <table style="border-spacing: 0px;">
                                        ...
                                        <tr>
                                            <td>RSV_AMT10</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT10" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT11</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT11" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT12</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT12" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT13</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT13" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT14</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT14" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT15</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT15" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT16</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT16" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT17</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT17" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT18</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT18" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>RSV_AMT19</td>
                                            <td>
                                                <asp:TextBox ID="TXT_RAMT19" runat="server" CssClass="ASPTextBox" Width="200px" BackColor="Silver"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
