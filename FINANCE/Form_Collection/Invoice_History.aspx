<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice_History.aspx.cs" Inherits="FINANCE.Form_Collection.Invoice_History" %>
                ...
                <td>
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="NOMOR" HeaderText="DOCUMENT NO."></asp:BoundColumn>
                            <asp:BoundColumn DataField="TGL" HeaderText="DATE"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="INVOICE_TYPE_DESCR" Visible="False"></asp:BoundColumn>
                             <asp:TemplateColumn>
                               <ItemTemplate>
                                    <asp:Button ID="BT_DEL" runat="server" BackColor="Red" CssClass="ASPButton" Font-Bold="True" ForeColor="White" Text="X" CommandName="Delete" Visible ="true"/>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
