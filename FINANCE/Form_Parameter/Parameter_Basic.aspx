<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parameter_Basic.aspx.cs" Inherits="FINANCE.Form_Parameter.Parameter_Basic" %>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="upBody" runat="server">
                <ContentTemplate>
                    <table class="style1" style="top: 0px; left: 0px; width: 100%; position: absolute; 
                                        height: 100%">
                        <tr>
                            <td class="style2" valign="top">
                                ...
                                <asp:ListBox ID="LBX_PARAM" runat="server" AutoPostBack="True" CssClass="ASPDropDownList" OnSelectedIndexChanged="LBX_PARAM_SelectedIndexChanged" Height="500px"  Width="100%"></asp:ListBox>
                                <asp:DataGrid ID="DGR0" runat="server" AutoGenerateColumns="False"
                                BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px"
                                CellPadding="4" Font-Names="Tahoma" OnItemCommand="DGR0_ItemCommand" Font-Size="X-Small"
                                ...
                                <tr>
                                    <td>
                                        <asp:DataGrid ID="DGR2" runat="server" BackColor="White"
                                            ...
                                            PageSize="20" Width="90%" AutoGenerateColumns="False" OnItemCommand="DGR2_ItemCommand"
                                             ShowFooter="True" OnSelectedIndexChanged="DGR2_SelectedIndexChanged">
                                ...
                                <tr>
                                    <td>
                                        <asp:DataGrid ID="DGR1" runat="server" BackColor="White"
                                            BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                            CellSpacing="1" Font-Names="Tahoma" Font-Size="X-Small" GridLines="Horizontal"
                                            PageSize="20"  OnItemCommand="DGR1_ItemCommand" OnPageIndexChanged="DGR1_PageIndexChanged"
                                             Width="600px" ItemStyle-Wrap="true">
                                            <SelectedItemStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
