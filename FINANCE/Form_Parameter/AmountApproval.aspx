<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AmountApproval.aspx.cs" Inherits="FINANCE.Form_Parameter.AmountApproval" %>
...
<body>
    <form id="form1" runat="server">
        <table style="top: 0px; left: 0px; border-spacing: 0px; width: 100%; font-size: xx-small;">
            <tr>
                <td style="width: 50%;">
                    <table style="top: 0px; left: 0px; border-spacing: 0px; width: 99%;">
                        <tr>
                            <td style="text-align: left;" class="TDBGColor">PROCESS
                            </td>
                            <td style="text-align: right; width: 100px;" class="TDBGColor">BOTTOM LIMIT
                            </td>
                            <td style="text-align: right; width: 100px;" class="TDBGColor">UPPER LIMIT
                            </td>
                            <td style="width: 60px;"></td>
                        </tr>
                        <tr style="vertical-align: bottom;">
                            <td>
                                <asp:DropDownList ID="DDL_APP" Font-Size="XX-Small" runat="server" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="DDL_APP_SelectedIndexChanged"></asp:DropDownList><br />
                                <asp:DropDownList ID="DDL_PROCESS" Font-Size="XX-Small" runat="server" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="DDL_PROCESS_SelectedIndexChanged"></asp:DropDownList>
                            </td>
                            <td>
                                <asp:TextBox ID="TXT_BOTTOM" runat="server" Font-Size="XX-Small" Width="100%" Style="text-align: right;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="TXT_UPPER" runat="server" Font-Size="XX-Small" Width="100%" Style="text-align: right;"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Button ID="BT_SAVE" runat="server" Font-Size="XX-Small" Text="ADD" Width="80px" OnClick="BT_SAVE_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr style="vertical-align: top;">
                <td>
                    <asp:DataGrid ID="DGRQUERY" runat="server" AutoGenerateColumns="False"
                        ...
                        GridLines="Vertical" PageSize="20" ForeColor="#333333" BorderColor="#6699FF" OnItemCommand="DGRQUERY_ItemCommand" ShowHeader="False" Width="99%" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False">
                    ...
                    <table id="TBL_DETAIL" runat="server" visible="false" style="top: 0px; left: 0px; border-spacing: 0px; width: 100%;">
                        ...
                        <tr>
                            <td>
                                <table style="top: 0px; left: 0px; border-spacing: 0px; width: 100%;">
                                    <tr>
                                        <td style="text-align: center; width: 50%;" class="TDBGColor">UNSELECTED USER
                                        </td>
                                        <td style="text-align: center; width: 50%;" class="TDBGColor">SELECTED USER
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
