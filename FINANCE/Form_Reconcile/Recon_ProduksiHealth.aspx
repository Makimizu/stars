<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recon_ProduksiHealth.aspx.cs" Inherits="FINANCE.Form_Reconcile.Recon_ProduksiHealth" MaintainScrollPositionOnPostback="true" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="PARAM_KEY" HeaderText="INVOICE NO"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="AMOUNT_OTHER" HeaderText="AMOUNT OTHER">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
