<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recon_Bank.aspx.cs" Inherits="FINANCE.Form_Reconcile.Recon_Bank" MaintainScrollPositionOnPostback="true" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="NOREK" HeaderText="NO REKENING"></asp:BoundColumn>
                            <asp:BoundColumn DataField="BANK_NAME" HeaderText="BANK NAME"></asp:BoundColumn>

                            <asp:BoundColumn DataField="DEBIT_BANK" HeaderText="DEBIT BANK">
                            ...
                            <asp:BoundColumn DataField="CREDIT_BANK" HeaderText="CREDIT BANK">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="COA_DESCR" HeaderText="COA DESCRIPTION"></asp:BoundColumn>

                             <asp:BoundColumn DataField="DEBIT_REPORT" HeaderText="DEBIT REPORT">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Green" HorizontalAlign="Right" />
                            </asp:BoundColumn>

                            <asp:BoundColumn DataField="CREDIT_REPORT" HeaderText="CREDIT REPORT">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Blue" HorizontalAlign="Right" />
                            </asp:BoundColumn>

                             <asp:BoundColumn DataField="SELISIH_DEBIT" HeaderText="SELISIH DEBIT">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Green" HorizontalAlign="Right" />
                            </asp:BoundColumn>

                            <asp:BoundColumn DataField="SELISIH_CREDIT" HeaderText="SELISIH CREDIT">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Blue" HorizontalAlign="Right" />
                            </asp:BoundColumn>

                            <asp:BoundColumn DataField="REMARK_DEBIT" HeaderText="REMARK DEBIT">
                                    <ItemStyle Font-Bold="True" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="REMARK_CREDIT" HeaderText="REMARK CREDIT">
                                    <ItemStyle Font-Bold="True" />
                            </asp:BoundColumn>
                            ...
                            <asp:TemplateColumn HeaderText="DETAIL SELISIH" ItemStyle-Width="300px" >
                                ...
                                <%--<asp:LinkButton ID="LB_DETAIL_JD" runat="server" CssClass="ASPLabel" Text="Journal Detail" /> &nbsp;|
                                    <asp:LinkButton ID="LB_DETAIL_RJ" runat="server" CssClass="ASPLabel" Text="Rekening Journal" /> &nbsp;&nbsp;--%>
                                </ItemTemplate>
