...
{
    public partial class ProduksiGLIFE : System.Web.UI.Page
    {
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            string filename = "List_AutoRecon_ProduksiGLIFE_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx";
            ...
            {
                ExcelWorksheet ws = pck.Workbook.Worksheets.Add("List_AutoRecon_ProduksiGLIFE");
                ws.Cells["A1"].Value = "Report";
                ws.Cells["A2"].Value = "Period";
                ws.Cells["B1"].Value = ": SUMMARY PRODUKSI GLIFE ";
        ...
        public DataTable GetListReconKomisiHealth(string startDate, string endDate)
        {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(sqlDataSource))
                {
                    ...
                    string spName = "AutoReportReconcile.[dbo].[SP_ReconGLIFEProduksi]";
        ...
        public void GetDetailDGR(DataGrid dgr, string startDate, string endDate)
        {
            ...
            for (int i = 0; i < DGR.Items.Count; i++)
            {
                ...
                string remark = DGR.Items[i].Cells[14].Text.Trim();
                string code = DGR.Items[i].Cells[13].Text.Trim() + "_" + remark + "_" + tanggal;
