<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProduksiGLIFE.aspx.cs" Inherits="FINANCE.Form_AutoReconcile.ProduksiGLIFE" %>
                    ...
                    <br />
                     ...
                     <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AMOUNT_INV" HeaderText="AMOUNT INVOICE" DataFormatString="{0:N2}">
                            ...
                            <asp:BoundColumn DataField="AMOUNT_PRD" HeaderText="AMOUNT PRODUKSI" DataFormatString="{0:N2}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="ID_INV" HeaderText="ID INVOICE"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ID_PRD" HeaderText="ID PRODUKSI"></asp:BoundColumn>
