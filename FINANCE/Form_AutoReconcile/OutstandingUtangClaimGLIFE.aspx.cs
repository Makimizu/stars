...
{
    public partial class OutstandingUtangClaimGLIFE : System.Web.UI.Page
    {
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            string filename = "List_AutoRecon_UtangKlaimGLIFE_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx";
            ...
            using (ExcelPackage pck = new ExcelPackage())
            {
                ...
                ws.Cells["B1"].Value = ": SUMMARY UTANG KLAIM GLIFE ";
        ...
        public DataTable GetListReconKomisiHealth(string startDate, string endDate)
        {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(sqlDataSource))
                {
                    ...
                    string spName = "AutoReportReconcile.[dbo].[SP_OutstandingUtangClaimGLIFE]";
        ...
        public void GetDetailDGR(DataGrid dgr, string startDate, string endDate)
        {
            ...
            conn.QueryString = "select URLAPP from FINANCE.dbo.V_LINK_SC_REPORT_LIST b where b.APP_ID = 'FN' and b.CODE = 399";
            conn.ExecuteQuery();
