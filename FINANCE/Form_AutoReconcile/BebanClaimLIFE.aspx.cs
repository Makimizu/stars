...
{
    public partial class BebanClaimLIFE : System.Web.UI.Page
    {
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            string filename = "List_Recon_BebanClaimHealth_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx";
            ...
            {
                ExcelWorksheet ws = pck.Workbook.Worksheets.Add("List_Recon_BebanClaimHealth");
                ws.Cells["A1"].Value = "Report";
                ws.Cells["A2"].Value = "Period";
                ws.Cells["B1"].Value = ": SUMMARY BEBAN CLAIM HEALTH ";
        ...
        public DataTable GetListReconKomisiHealth(string startDate, string endDate)
        {
            ...
            using (SqlConnection conn = new SqlConnection(sqlDataSource))
            {
                ...
                string spName = "AutoReportReconcile.[dbo].[SP_ReconBebanClaimLIFE]";
        ...
        public void GetDetailDGR(DataGrid dgr, string startDate, string endDate)
        {
            ...
            conn.QueryString = "select URLAPP from FINANCE.dbo.V_LINK_SC_REPORT_LIST b where b.APP_ID = 'FN' and b.CODE = 395";
            conn.ExecuteQuery();
