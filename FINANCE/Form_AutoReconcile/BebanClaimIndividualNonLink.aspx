<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BebanClaimIndividualNonLink.aspx.cs" Inherits="FINANCE.Form_AutoReconcile.BebanClaimIndividualNonLink" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AMOUNT_REPORT_ACCOUNTING" HeaderText="AMOUNT RPT ACCOUNTING">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="ID_REPORT_ACCOUNTING" HeaderText="ID RPT ACCOUNTING"></asp:BoundColumn>
