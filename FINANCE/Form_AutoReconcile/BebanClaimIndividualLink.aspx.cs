...
{
    public partial class BebanClaimIndividualLink : System.Web.UI.Page
    {
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            string filename = "List_Recon_BebanClaimIndividualLink_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx";
            ...
            {
                ExcelWorksheet ws = pck.Workbook.Worksheets.Add("List_Recon_BebanClaimIndividual_Link");
                ws.Cells["A1"].Value = "Report";
                ws.Cells["A2"].Value = "Period";
                ws.Cells["B1"].Value = ": SUMMARY BEBAN CLAIM INDIVIDUAL LINK ";
        ...
        public DataTable GetListReconKomisiHealth(string startDate, string endDate)
        {
            ...
            using (SqlConnection conn = new SqlConnection(sqlDataSource))
            {
                ...
                string spName = "AutoReportReconcile.dbo.SP_ReconBebanClaimIndividualLink";
        ...
        public void GetDetailDGR(DataGrid dgr, string startDate, string endDate)
        {
            ...
            conn.QueryString = "select URLAPP from FINANCE.dbo.V_LINK_SC_REPORT_LIST b where b.APP_ID = 'FN' and b.CODE = 397";
            conn.ExecuteQuery();
