<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BebanClaimIndividual.aspx.cs" Inherits="FINANCE.Form_AutoReconcile.BebanClaimIndividual" %>
                ...
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AMOUNT_CLAIM_DETAIL" HeaderText="AMOUNT CLAIM DETAIL">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="AMOUNT_CLAIM_MASTER" HeaderText="AMOUNT CLAIM MASTER">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="ID_CLAIMDETAIL" HeaderText="ID CLAIM DETAIL"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ID_CLAIMMASTER" HeaderText="ID CLAIM MASTER"></asp:BoundColumn>
