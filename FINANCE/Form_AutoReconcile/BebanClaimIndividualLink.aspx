<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BebanClaimIndividualLink.aspx.cs" Inherits="FINANCE.Form_AutoReconcile.BebanClaimIndividualLink" %>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AMOUNT_JD" HeaderText="AMOUNT JOURNAL DETAIL">
                             ...
                             <asp:BoundColumn DataField="AMOUNT_CLAIM_INVEST" HeaderText="AMOUNT CLAIM INVEST">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Green" HorizontalAlign="Right" />
                            </asp:BoundColumn>

                            <asp:BoundColumn DataField="AMOUNT_REQPAY" HeaderText="AMOUNT REQPAY">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="AMOUNT_CLAIM_UNITLINK" HeaderText="AMOUNT CLAIM UNITLINK">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                            ...
                            <asp:BoundColumn DataField="ID_CLAIM_INVEST" HeaderText="ID CLAIM INVEST"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ID_REQPAY" HeaderText="ID REQPAY"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ID_CLAIM_UNIT_LINK" HeaderText="ID CLAIM UNIT LINK"></asp:BoundColumn>
