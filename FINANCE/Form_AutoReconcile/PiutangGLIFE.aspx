<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PiutangGLIFE.aspx.cs" Inherits="FINANCE.Form_AutoReconcile.PiutangGLIFE" %>
                ...
                <td>
                  ...
                  <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="AMOUNT_INV" HeaderText="AMOUNT INV" DataFormatString="{0:N2}">
                            ...
                            <asp:BoundColumn DataField="AMOUNT_PRD" HeaderText="AMOUNT PRD" DataFormatString="{0:N2}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                             ...
                             <asp:BoundColumn DataField="AMOUNT_JD" HeaderText="AMOUNT JD" DataFormatString="{0:N2}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Right" Width="100px" />
                                <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="Blue" HorizontalAlign="Right" />
                            </asp:BoundColumn>

                            <asp:BoundColumn DataField="ID_INV" HeaderText="ID INV"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ID_PRD" HeaderText="ID PRD"></asp:BoundColumn>
                            <asp:BoundColumn DataField="ID_JD" HeaderText="ID JD"></asp:BoundColumn>
