...
{
    public partial class BebanClaimRisk : System.Web.UI.Page
    {
        ...
        protected void BT_DOWNLOAD_Click(object sender, EventArgs e)
        {
            ...
            string filename = "List_Recon_BebanClaimIndividualRisk_" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx";
            ...
            {
                ExcelWorksheet ws = pck.Workbook.Worksheets.Add("List_Recon_BebanClaimIndividual_Risk");
                ws.Cells["A1"].Value = "Report";
                ws.Cells["A2"].Value = "Period";
                ws.Cells["B1"].Value = ": SUMMARY BEBAN CLAIM INDIVIDUAL RISK ";
        ...
        public DataTable GetListReconKomisiHealth(string startDate, string endDate)
        {
            ...
            using (SqlConnection conn = new SqlConnection(sqlDataSource))
            {
                ...
                string spName = "AutoReportReconcile.dbo.SP_ReconGLIFEBebanClaimRisk";
        ...
        protected void FillDGR()
        {
            ...
            else
            {
                ...
                //startDate = startDateTxt.ToString("dd/MM/yyyy");
                //endDate = endDateTxt.ToString("dd/MM/yyyy");
            }
        ...
        public void GetDetailDGR(DataGrid dgr, string startDate, string endDate)
        {
            ...
            conn.QueryString = "select URLAPP from FINANCE.dbo.V_LINK_SC_REPORT_LIST b where b.APP_ID = 'FN' and b.CODE = 390";
            conn.ExecuteQuery();
            ...
            for (int i = 0; i < DGR.Items.Count; i++)
            {
                ...
                string id = DGR.Items[i].Cells[6].Text;


                string remark = DGR.Items[i].Cells[9].Text.Trim();
                string code = DGR.Items[i].Cells[8].Text.Trim() + "_" + remark + "_" + tanggal;


                LinkButton lbDetail = (LinkButton)DGR.Items[i].FindControl("LB_DETAIL");


                string paramDetail = urlDetail + "&ID=" + id + "&CODE_RPT=" + code +
