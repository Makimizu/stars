<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadBatch.aspx.cs" Inherits="SAVING.Form_Trx.UploadBatch" %>
                ...
                <td>
                    <table style="border-spacing: 0px; width: 100%; font-size: xx-small;">
                        ...
                        <tr>
                            <td>BATCH MODE</td>
                            <td>
                                <asp:DropDownList ID="DDL_MODE" runat="server" CssClass="ASPDropDownList" AutoPostBack="true" OnSelectedIndexChanged="DDL_MODE_SelectedIndexChanged"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td>
        ...
        <div style="background-color: transparent !important; opacity: 0.9;">
            <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="500px" Width="90%" Style="z-index: 111; background-color: White; position: fixed; left: 60px; top: 0px; border: outset 2px gray; padding: 5px; display: none">
                ...
                <div style="width: 100%; height: 470px; overflow: auto;">
                    ...
                    <asp:DataGrid ID="DGR_RAW" runat="server" CellPadding="2" Font-Names="Tahoma" GridLines="Vertical" Width="100%" ItemStyle-Wrap="true" PageSize="20" AllowPaging="True" OnPageIndexChanged="DGR_RAW_PageIndexChanged" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Font-Size="XX-Small" ForeColor="#333333">
