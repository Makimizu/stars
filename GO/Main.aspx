<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="GO.Main" %>
...
<frameset rows="70,*" frameborder="0" border="0" framespacing="0">  
    ...
    <frameset cols="200,*" frameborder="0" border="0" framespacing="0">
	    ...
	    <frameset rows="30,*" frameborder="0" border="0" framespacing="0">
	        ...
	        <frame name="content" src="Statistic.aspx" marginheight="0" marginwidth="0" scrolling="auto" noresize>
        </frameset>
    </frameset>
</frameset>
</html>
