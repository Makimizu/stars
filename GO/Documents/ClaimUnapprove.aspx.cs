...
namespace GLIFE.Form_Claim
{
    public partial class ClaimUnapprove : System.Web.UI.Page
    {
        ...
        {
            conn.QueryString = "select SEQ, DESCR from PARAM_TRACK where TIPE_CODE = 'CLM' and SEQ in (4)";
            conn.ExecuteQuery();
        ...
        protected void FillDGR()
        {
            ...
            conn.QueryString = "select " +
                                ...
                                "where a.REGNO in(select REPLACE(DOCNO,right(DOCNO,2),'') collate database_default " +
                                                    ...
                                                    "where a.APP_ID='GL' and b.PROCESSBY is null)" +
                                "and a.LAST_TRACK = " + DDL_STAT.SelectedValue + " " + where + " " +
