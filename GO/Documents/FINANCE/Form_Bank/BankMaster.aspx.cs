...
namespace FINANCE.Form_Bank
{
    public partial class BankMaster : System.Web.UI.Page
    {
        ...
        protected void InsertBank(string bank, string city, string branch, string branchCode, string clearingCode, string rtgsCode)
        {
            try
            {
                conn.QueryString = "EXEC SP_MASTER_BANK_INSERT '" +
                       DDL_GROUPBANK.SelectedValue + "', '" +
                       TXT_NAMA_BANK.Text.ToUpper() + "', '" +
                       TXT_KOTA.Text.ToUpper() + "', '" +
                       TXT_CABANG.Text.ToUpper() + "', '" +
                       TXT_KODE_CABANG.Text.ToUpper() + "', '" +
                       TXT_CLEARING_CODE.Text.ToUpper() + "', '" +
                       TXT_RTGS_CODE.Text.ToUpper() + "'";
