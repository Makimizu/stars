<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Memo.aspx.cs" Inherits="FINANCE.Form_Settlement.Memo" MaintainScrollPositionOnPostback="true" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="BT_RFD" runat="server" BackColor="Green" CommandName="Refund" CssClass="ASPButton" Font-Bold="True" ForeColor="White" Text="RF" />
                                </ItemTemplate>
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                            ...
                            <asp:BoundColumn DataField="DESTINATION_BANK_DESCR" HeaderText="DESTINATION BANK">
                            </asp:BoundColumn>
            ...
            <tr id="TR_RFD" runat="server" visible="false">
                <td>
                    <table style="border-spacing:0px;">
                        ...
                        <tr>
                            <td></td>
                            <td><asp:Button ID="BT_PROCESS_RFD" runat="server" CssClass="ASPButton" Font-Bold="True" ForeColor="Green" OnClick="BT_PROCESS_RFD_Click" Text="SUBMIT REFUND" /></td>
                        </tr>
                    </table>                    
                    <asp:DataGrid ID="DGR_RFD" runat="server" BorderColor="#003300" CellPadding="4" PageSize="40"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="TIPE_SETTLEMENT" Visible="False">
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="CUSTOMER_CODE" Visible="False">
                            </asp:BoundColumn>
