<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GL_Period.aspx.cs" Inherits="FINANCE.Form_Accounting.GL_Period" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="START">
                                <ItemTemplate>
                                    ...
                                    <ajaxToolkit:CalendarExtender ID="cdSTART" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_STARTDATE">
                                    </ajaxToolkit:CalendarExtender>
                                    <asp:DropDownList ID="DDL_STARTHH" runat="server" CssClass="ASPDropDownList">
                                    ...
                                    <asp:DropDownList ID="DDL_STARTMM" runat="server" CssClass="ASPDropDownList">
                                        <asp:ListItem>00</asp:ListItem>
                                        <asp:ListItem>01</asp:ListItem>
                                        <asp:ListItem>02</asp:ListItem>
                                        <asp:ListItem>03</asp:ListItem>
                            ...
                            <asp:TemplateColumn HeaderText="END">
                                <ItemTemplate>
                                    ...
                                    <asp:DropDownList ID="DDL_ENDHH" runat="server" CssClass="ASPDropDownList">
                                        <asp:ListItem>00</asp:ListItem>
                                        <asp:ListItem>01</asp:ListItem>
                                        <asp:ListItem>02</asp:ListItem>
                                        <asp:ListItem>03</asp:ListItem>
                                    ...
                                    <asp:DropDownList ID="DDL_ENDMM" runat="server" CssClass="ASPDropDownList">
                                        <asp:ListItem>00</asp:ListItem>
                                        <asp:ListItem>01</asp:ListItem>
                                        <asp:ListItem>02</asp:ListItem>
                                        <asp:ListItem>03</asp:ListItem>
                            ...
                            <asp:BoundColumn DataField="CLOSED_BY" HeaderText="CLOSED BY"></asp:BoundColumn>
                            <asp:BoundColumn DataField="CLOSED_DATE" HeaderText="CLOSED DATE"></asp:BoundColumn>
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="BT_CLOSE" runat="server" CommandName="Close" BackColor="Red" CssClass="ASPButton" Font-Bold="True" ForeColor="White" Text="C" Visible="false"/>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
