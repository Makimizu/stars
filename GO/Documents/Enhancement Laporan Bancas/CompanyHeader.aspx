                        ...
                        <tr style="vertical-align: top;">
                            <td>
                                <table style="border-spacing: 0px;">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label runat="server" ID="LBGROUP" CssClass="ASPLabel" Text="COMPANY GROUP"></asp:Label></td>
                                        <td>
                                            <asp:DropDownList ID="DDL_COMPANY_GROUP" runat="server" CssClass="ASPDropDownList">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
