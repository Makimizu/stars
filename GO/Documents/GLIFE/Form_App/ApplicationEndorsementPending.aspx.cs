...
{
    public partial class ApplicationEndorsementPending : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            conn.QueryString = "select " +
                                ...
                                "left join APPLICATION_MASTER_PENDING b on a.CODE = b.PENDING_CODE and b.REGNO = '" + LB_REGNO.Text + "' and b.SEQ = '" + LB_SEQ.Text + "-" + LB_TYPE.Text + "' " +
                                "where " +
                                "a.PROCESS_CODE = 'POS'";
            conn.ExecuteQuery();
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                ClientScript.RegisterStartupScript(GetType(), "", "<script language='javascript'>parent.POSpendingbody.location.href = 'ApplicationEndorsementPending" + e.Item.Cells[0].Text + ".aspx?REGNO=" + LB_REGNO.Text + "&SEQ=" + LB_SEQ.Text + "-" + LB_TYPE.Text + "&type=" + e.Item.Cells[0].Text + "';</script>");
            }

            if (e.CommandName == "Start")
            {
                conn.QueryString = "insert into APPLICATION_MASTER_PENDING select " +
                                    "'" + LB_REGNO.Text + "'," +
                                    "'" + LB_SEQ.Text + "-" + LB_TYPE.Text + "'," +
                                    "'" + e.Item.Cells[0].Text + "'," +
                                    "null," +
            ...
            if (e.CommandName == "Stop")
            {
                ...
                conn.QueryString = "update APPLICATION_MASTER_PENDING set " +
                                    ...
                                    "where " +
                                    "REGNO = '" + LB_REGNO.Text + "' " +
                                    "and SEQ = '" + LB_SEQ.Text + "-" + LB_TYPE.Text + "' " +
