                                ...
                                <table style="border-spacing: 0px; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_SEND_DATE_START">
                                            </ajaxToolkit:CalendarExtender>
                                            &nbsp;-&nbsp;
                                            <asp:TextBox ID="TXT_SEND_DATE_END" runat="server" CssClass="ASPTextBox" Width="80px" Style="text-align: center;"></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender5" runat="server" Format="dd/MM/yyyy" TargetControlID="TXT_SEND_DATE_END">
                                            </ajaxToolkit:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <tr>
                <td>
                    ...
                    <asp:DataGrid ID="DGR" runat="server" BackColor="White"
                        ...
                        Width="100%" ItemStyle-Wrap="true" AutoGenerateColumns="False" AllowPaging="True" PageSize="10" CssClass="ASPDatagrid">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="EMAIL CC">
                                <ItemTemplate>
                                    <asp:TextBox ID="TXT_EMAIL_CC" runat="server" CssClass="ASPTextBox" Width="200px"  Text='<%# Eval("EMAIL_CC") %>'></asp:TextBox>
                                </ItemTemplate>
                                <HeaderStyle Width="250px" />
                            </asp:TemplateColumn>
