<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiScreensHeader.aspx.cs" Inherits="GO.MultiScreensHeader" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <table style="top: 0px; left: 0px; position: absolute; border-spacing: 0px; width: 100%;">
            <tr style="vertical-align: top;">
                <td>
                    <asp:Label ID="LB_CAPTION" runat="server" Font-Bold="True"></asp:Label>
