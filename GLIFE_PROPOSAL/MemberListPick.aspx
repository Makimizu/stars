<%@ Page Language="C#" MasterPageFile="~/Parent.Master" AutoEventWireup="true" CodeBehind="MemberListPick.aspx.cs" Inherits="GLIFE_PROPOSAL.MemberListPick" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<link href="include/css/tabpanelround.css" rel="stylesheet" />--%>
                ...
                <td>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: right; font-size: 12pt;">SEARCH EXISTING CUSTOMER&nbsp;:&nbsp;
                                                <asp:Label ID="LB_RESULT" runat="server" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <asp:TextBox ID="TXT_FULLNAME_SEARCH" runat="server" AutoPostBack="true" CssClass="TextBox" Width="100%" placeholder="Search Name" OnTextChanged="TXT_FULLNAME_SEARCH_TextChanged"></asp:TextBox>
                </td>
            </tr>
        </table>
