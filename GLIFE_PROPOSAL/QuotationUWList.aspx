<%@ Page Language="C#" MasterPageFile="~/Parent.Master" AutoEventWireup="true" CodeBehind="QuotationUWList.aspx.cs" Inherits="GLIFE_PROPOSAL.QuotationUWList" %>
                    ...
                    <%--<tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDL_UW" runat="server" CssClass="ASPDropDownList" AutoPostBack="True" OnSelectedIndexChanged="DDL_UW_SelectedIndexChanged">
                                <asp:ListItem Value="and UW_CODE in ('AC','FC')">FREE COVER</asp:ListItem>
                                <asp:ListItem Value="and UW_CODE='NM'">NON MEDICAL</asp:ListItem>
                                <asp:ListItem Value="and UW_CODE not in ('AC','FC','NM','00','')">MEDICAL</asp:ListItem>
