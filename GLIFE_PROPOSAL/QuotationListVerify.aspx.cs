...
{
    public partial class QuotationListVerify : System.Web.UI.Page
    {
        ...
        {
            LB_RESULT.Text = "";
            string where = " and a.LAST_TRACK = 2 ";
            ...
            for (int i = 0; i < DGR.Items.Count; i++)
            {
                ...
                //    DGR.Items[i].Cells[4].Text.Replace("&nbsp;", "") != "AC" && 
                //    DGR.Items[i].Cells[4].Text.Replace("&nbsp;", "") != "FC")
                //    cb.Visible = false;
            }
            ...
            if (e.CommandName == "Check")
            {
                for (int i = 0; i < DGR.Items.Count; i++)
                {
                    ...
                    if (cb.Checked)
                    {
                        try
                        {
                            conn.QueryString = "exec GLIFE.dbo.SP_LINK_GLIFE_QUOTATION_MASTER_CONFIRMED " +
