<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GLIFE_PROPOSAL.Login" %>
                        ...
                        <div class="login-form">
                            <div class="sign-in-htm">
                                ...
                                <div class="group">
                                    ...
                                    <%--<asp:TextBox ID="TXT_PWD" runat="server" class="input" data-type="password"></asp:TextBox>--%>
                                     <asp:TextBox ID="TXT_PWD" runat="server" class="input" TextMode="Password"></asp:TextBox>
                                    <input type="checkbox" onchange="document.getElementById('TXT_PWD').type = this.checked ? 'text' : 'password'">
            Show password
                                </div>
