...
{
    public partial class Policy_Claim_Regno : System.Web.UI.Page
    {
        ...
        protected void FillDGRClaim()
        {
            conn.QueryString = "select " +
                                ...
                                "from V_LINK_HO_PESERTA_MASTER a " +
                                "inner join V_LINK_HO_PR_FAMILY_GROUP c on a.FAMILY_GROUP=c.CODE " +
                                "inner join V_LINK_HO_POLICY_PERIOD b on a.POLICY_ID=b.POLICY_ID " +
                                "where " +
            ...
            conn.QueryString = "exec SP_LINK_HO_PESERTA_MASTER_CLAIM_PERIOD '" + LB_REGNO.Text + "','" + LB_PERIOD.Text + "'";
            conn.ExecuteQuery();
