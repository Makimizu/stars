<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationQuestionHeader.aspx.cs" Inherits="LQR.ApplicationQuestionHeader" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:DataGrid ID="DGR_BUTTON" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" Font-Size="8pt" GridLines="None" ItemStyle-Wrap="true" PageSize="20" ShowHeader="False" Width="100%" CssClass="ASPDatagrid" OnItemCommand="DGR_BUTTON_ItemCommand">
            ...
            <Columns>
                ...
                <asp:TemplateColumn>
                    <ItemTemplate>
                        <asp:Button ID="BT_GROUP" runat="server" Width="100%" CommandName="Detail" Style="white-space: normal;" Font-Size="x-Small" />
                    </ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
        </asp:DataGrid>
        ...
        <br />
        <br />
        <asp:Button ID="BT_AGREEMENT" runat="server" Width="100%" Text="PERNYATAAN PERSETUJUAN" BackColor="Green" ForeColor="White" Style="white-space: normal;" Font-Size="x-Small" OnClick="BT_AGREEMENT_Click" />
