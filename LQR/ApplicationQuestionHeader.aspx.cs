...
namespace LQR
{
    public partial class ApplicationQuestionHeader : System.Web.UI.Page
    {
        ...
        {
            ClientScript.RegisterStartupScript(GetType(), "", "<script language='javascript'>parent.QuestionBody.location.href = 'ApplicationAgreement.aspx?REGNO=" + LB_REGNO.Text + "';</script>");
        }
    }
}