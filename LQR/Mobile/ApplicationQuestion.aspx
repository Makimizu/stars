<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationQuestion.aspx.cs" Inherits="LQR.Mobile.ApplicationQuestion" %>
                                            ...
                                            <td>
                                                <table style="border-spacing: 0px; width: 100%;">
                                                    <tr style="vertical-align: top;">
                                                        <td>
                                                            <asp:Label ID="LB_DESCR" runat="server" />
                                                            <br />
                                                                            ...
                                                                            <table style="border-spacing: 0px; width: 100%;">
                                                                                <tr style="vertical-align: top;">
                                                                                    <td>
                                                                                        ...
                                                                                        <br />
                                                                                        <asp:DropDownList ID="DropDownList1" runat="server" Visible="False" Enabled="false" Style="border: 0; color: black;"></asp:DropDownList>
                                                                                        <asp:TextBox ID="TextBox1" runat="server" Visible="False" Width="95%" MaxLength="255" ReadOnly="true"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                            ...
                                                                            <table style="border-spacing: 0px; width: 100%; border-top: inset;">
                                                                                <tr style="vertical-align: top;">
                                                                                    <td>
                                                                                        ...
                                                                                        <br />
                                                                                        <asp:TextBox ID="TextBox2" runat="server" Width="95%" MaxLength="255" Visible="false" BackColor="LightYellow" TextMode="MultiLine" Height="30" ReadOnly="true"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
