...
namespace AGR
{
    public partial class TRAINING_SUBMODULE : System.Web.UI.Page
    {
        ...
        {
            conn.QueryString = "exec SP_TRAINING_MASTER_SUB '" + LB_TRAINING_CODE.Text + "' ";
            conn.ExecuteQuery();
            DataTable dt;
            dt = new DataTable();
            ...
            {
                TextBox txt = (TextBox)DGR.Items[i].FindControl("TXT_SUBJECT");
        ...
        protected void BT_SAVE_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < DGR.Items.Count; i++)
            {
                ...
                {
                    TextBox txt = (TextBox)DGR.Items[i].FindControl("TXT_SUBJECT");
                    conn.QueryString = "exec SP_TRAINING_MASTER_SUB_UPSERT " +
