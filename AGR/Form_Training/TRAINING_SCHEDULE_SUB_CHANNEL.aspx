<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TRAINING_SCHEDULE_SUB_CHANNEL.aspx.cs" Inherits="AGR.TRAINING_SCHEDULE_SUB_CHANNEL" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="TXT_SCHEDULE_CODE" runat="server" Visible="false"></asp:Label>

        <table style="border-spacing: 0px; font-size: x-small; width: 100%;">
            <tr>
                <td style="width: 50%" class="TDBGColor">SUB CODE INPUT</td>
                <td style="width: 50%" class="TDBGColor">SUB CODE LIST</td>
            </tr>
                            ...
                            <td>
                                <table style="border-spacing: 0px; font-size: x-small; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDL_SCHEDULE" runat="server"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>SUB_CODE</td>
                                        <td>
                                            <asp:DropDownList ID="DDL_SUBCODE" runat="server"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>SUB CHANNEL</td>
                                        <td>
                                            <asp:TextBox ID="TXT_SUB_CHANNEL" runat="server" Width="50%"></asp:TextBox>
                                        </td>
                                    </tr>
                ...
                <td>
                    <asp:DataGrid ID="DGR" runat="server" CellPadding="4" PageSize="20"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="TRAINING_NAME" HeaderText="TRAINING NAME"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SUB_CODE" HeaderText="SUB CODE"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SUB_CHANNEL" HeaderText="SUB CHANNEL"></asp:BoundColumn>
                        </Columns>
