<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DATA_BUSINESS_ALLOWANCE_SUMMARY.aspx.cs" Inherits="AGR.Form_Data.DATA_BUSINESS_ALLOWANCE_SUMMARY" %>
                            ...
                            <tr>
                                    ...
                                    <table style="border-spacing: 0px; width: 100%; font-size: x-small;">
                                        <tr>
                                            ...
                                            <td style="width: 100px;">
                                                <asp:Button ID="BT_BOOKED" runat="server" Text="BOOK" BackColor="Blue" ForeColor="White" Width="100" Font-Size="X-Small" OnClick="BT_BOOKED_Click" OnClientClick="hourglass(); return true;" /></td>
                                ...
                                <td style="width: 49%;">
                                    <table style="border-spacing: 0px; width: 100%; font-size: x-small;">
                                        <tr>
                                            <td style="width: 100px;">
                                                <asp:Button ID="BT_UNBOOK" runat="server" Text="UNBOOK" BackColor="Red" ForeColor="White" Width="100" Font-Size="X-Small" OnClick="BT_UNBOOK_Click" OnClientClick="hourglass(); return true;" />
                                                <%--OnClientClick="ShowProgress();"--%>
                                                <asp:Button ID="BT_FINANCE" runat="server" Text="PROCEED TO PAYMENT" BackColor="Green" ForeColor="White" Font-Size="X-Small" OnClick="BT_FINANCE_Click" OnClientClick="hourglass(); return true;" />
                                                <%--OnClientClick="ShowProgress();"--%>
                                            </td>
                                            <td class="TDBGColor">UNBOOKED</td>
                                        </tr>
