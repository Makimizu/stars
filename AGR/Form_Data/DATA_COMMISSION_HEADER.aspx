<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DATA_COMMISSION_HEADER.aspx.cs" Inherits="AGR.DATA_COMMISSION_HEADER" %>
                ...
                <td>
                    <table style="border-spacing: 0px; width: 100%;">
                        <tr>
                            ...
                            <td style="width: 33%;">
                                <asp:Button ID="BT2" runat="server" Text="SUMMARY" CssClass="ASPButton" Width="100%" OnClick="BT2_Click" /></td>
                            <td style="width: 33%;">
