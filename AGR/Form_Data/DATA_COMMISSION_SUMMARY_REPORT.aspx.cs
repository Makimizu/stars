...
{
    public partial class DATA_COMMISSION_SUMMARY_REPORT : System.Web.UI.Page
    {
        ...
        protected void FillDGR()
        {
            conn.QueryString = "select " +
                //"ID = '<a href=\"../../ReportViewer/Viewer.aspx?APPID=AGR&CODE=2&CD=" + DDL_CHANNEL.SelectedValue + "&PERIOD=' + convert(varchar(20), a.START_DATE, 112) + convert(varchar(20), a.END_DATE, 112) + '\" target=\"CommDetailBody\">' + convert(varchar(20), a.START_DATE, 106) + ' - ' + convert(varchar(20), a.END_DATE, 106)  + '</a>' " +
                                "ID = '<a href=\"../../reportviewer/viewer.aspx?appid=AGR&code=23&CD=" + DDL_CHANNEL.SelectedValue + "&PERIOD=' + CONVERT(VARCHAR(10), a.START_DATE) + ' - ' + CONVERT(varchar(10), a.END_DATE)  + '\" target=\"CommSummaryBody\">' + convert(varchar(20), a.START_DATE, 106) + ' - ' + convert(varchar(20), a.END_DATE, 106)  + '</a>' " +
