...
{
    public partial class DATA_BUSINESS_ALLOWANCE_SUMMARY : System.Web.UI.Page
    {
        ...
        protected void FillDGRUnbooked()
        {
            ...
            conn.QueryString = "exec SP_DATA_BUSINESS_ALLOWANCE_PERIOD " +
        ...
        {
            conn.QueryString = "exec SP_DATA_BUSINESS_ALLOWANCE_BOOK " +
                                "'" + DDL_CHANNEL.SelectedValue + "'," +
                                "'" + LB_STARTDATE.Text + "'," +
                                "'" + LB_ENDDATE.Text + "'," +
        ...
        {
            conn.QueryString = "exec SP_DATA_BUSINESS_ALLOWANCE_UNBOOK " +
                                "'" + DDL_CHANNEL.SelectedValue + "'," +
                                "'" + LB_STARTDATE.Text + "'," +
                                "'" + LB_ENDDATE.Text + "'";
            conn.ExecuteNonQuery();
