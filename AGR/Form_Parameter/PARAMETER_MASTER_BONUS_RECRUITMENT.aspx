<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PARAMETER_MASTER_BONUS_RECRUITMENT.aspx.cs" Inherits="AGR.Form_Parameter.PARAMETER_MASTER_BONUS_RECRUITMENT" %>
        ...
        <div id="DV_SCHEME" runat="server">
            ...
            <asp:DataGrid ID="DGR" runat="server" CellPadding="1" PageSize="20"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="BR_PCT" HeaderText="% BR"></asp:BoundColumn>
                    <asp:TemplateColumn>
