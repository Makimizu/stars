<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PARAMETER_NON_BASIC.aspx.cs" Inherits="AGR.PARAMETER_NON_BASIC" %>
                        ...
                        <tr>
                            <td>
                                <asp:DataGrid ID="DGRQUERY" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <ItemStyle BackColor="#EFF3FB" HorizontalAlign="Left" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Font-Size="XX-Small" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="False" ForeColor="White" Font-Italic="False" Font-Overline="False" Font-Size="XX-Small" Font-Strikeout="False" Font-Underline="False" VerticalAlign="Top" />
