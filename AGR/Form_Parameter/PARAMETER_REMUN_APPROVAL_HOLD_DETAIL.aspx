<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PARAMETER_REMUN_APPROVAL_HOLD_DETAIL.aspx.cs" Inherits="AGR.Form_Parameter.PARAMETER_REMUN_APPROVAL_HOLD_DETAIL" %>
...
<body>
    <form id="form1" runat="server">
        <table style="top: 0px; left: 0px; border-spacing: 0px; width: 99%; font-size: xx-small">
            ...
            <tr>
                <td style="width: 60%; vertical-align: top">
                    <asp:DataGrid ID="DGR_LEVEL" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="SystemCode" Visible="false"></asp:BoundColumn>
                            <asp:BoundColumn DataField="SystemValue" Visible="false"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="Approval Type">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="Link_Level" runat="server" CommandName="Select" ></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateColumn>
            ...
            <!--SELECTED AND UNSELECTED APPROVAL-->
            ...
            <!--END SELECTED AND UNSELECTED APPROVAL-->

            <!--CONTENT APPROVAL HOLD-->
