...
{
    public partial class PARAMETER_MASTER_BUSINESS_ALLOWANCE : System.Web.UI.Page
    {
        ...
        {
            conn.QueryString = "exec SP_PARAM_REMUN_BONUS_ALLOWANCE " +
                                "'" + LB_ID.Text + "'," +
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                conn.QueryString = "delete from PARAM_REMUN_BONUS_ALLOWANCE where " +
                                    "ID = '" + LB_ID.Text + "'";
        ...
        {
            conn.QueryString = "exec SP_PARAM_REMUN_BONUS_ALLOWANCE_DOWNLOAD '" + LB_ID.Text + "'";
            conn.ExecuteQuery();
            DataTable dt;
            dt = new DataTable();
            dt = conn.GetDataTable().Copy();

            GlobalUse.ExportDataSetToExcel(dt, this, "PARAM_REMUN_BONUS_ALLOWANCE", true);
        }
        ...
        {
            conn.QueryString = "delete from PARAM_REMUN_BONUS_ALLOWANCE where ID = '" + LB_ID.Text + "'";
            conn.ExecuteNonQuery();
            ...
            foreach (DataRow myRow in dt.Rows)
            {
                try
                {
                    conn.QueryString = "exec SP_PARAM_REMUN_BONUS_ALLOWANCE_UPLOAD " +
                                        "'" + LB_ID.Text + "'," +
