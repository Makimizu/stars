<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PARAMETER_MASTER_BONUS_ALLOWANCE.aspx.cs" Inherits="AGR.Form_Parameter.PARAMETER_MASTER_BUSINESS_ALLOWANCE" %>
        ...
        <div id="DV_SCHEME" runat="server">
            ...
            <asp:DataGrid ID="DGR" runat="server" CellPadding="1" PageSize="20"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="BA_PCT" HeaderText="% BA"></asp:BoundColumn>
                    <asp:TemplateColumn>
