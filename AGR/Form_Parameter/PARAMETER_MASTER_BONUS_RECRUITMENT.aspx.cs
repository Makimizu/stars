...
{
    public partial class PARAMETER_MASTER_BONUS_RECRUITMENT : System.Web.UI.Page
    {
        ...
        {
            conn.QueryString = "exec SP_PARAM_REMUN_BONUS_RECRUITMENT " +
                                "'" + LB_ID.Text + "'," +
        ...
        protected void DGR_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                conn.QueryString = "delete from PARAM_REMUN_BONUS_RECRUITMENT where " +
                                    "ID = '" + LB_ID.Text + "'";
        ...
        {
            conn.QueryString = "exec SP_PARAM_REMUN_BONUS_RECRUITMENT_DOWNLOAD '" + LB_ID.Text + "'";
            conn.ExecuteQuery();
            DataTable dt;
            dt = new DataTable();
            dt = conn.GetDataTable().Copy();

            GlobalUse.ExportDataSetToExcel(dt, this, "PARAM_REMUN_BONUS_RECRUITMENT", true);
        }
        ...
        {
            conn.QueryString = "delete from PARAM_REMUN_BONUS_RECRUITMENT where ID = '" + LB_ID.Text + "'";
            conn.ExecuteNonQuery();
            ...
            foreach (DataRow myRow in dt.Rows)
            {
                try
                {
                    conn.QueryString = "exec SP_PARAM_REMUN_BONUS_RECRUITMENT_UPLOAD " +
                                        "'" + LB_ID.Text + "'," +
        ...
        {
            conn.QueryString = "exec SP_PARAMETER_GUIDANCE '2a'";
            conn.ExecuteQuery();
            DataTable dt;
            dt = new DataTable();
            dt = conn.GetDataTable().Copy();
