<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PARAMETER_MASTER_BONUS_PROMOTION.aspx.cs" Inherits="AGR.Form_Parameter.PARAMETER_MASTER_BONUS_PROMOTION" %>
        ...
        <div id="DV_SCHEME" runat="server">
            ...
            <asp:DataGrid ID="DGR" runat="server" CellPadding="1" PageSize="20"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="BP_PCT" HeaderText="% BP"></asp:BoundColumn>
                    <asp:TemplateColumn>
