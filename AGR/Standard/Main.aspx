<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="AGR.Standard.Main" %>
...
<frameset rows="70,*" frameborder="0" border="0" framespacing="0">  
    ...
    <frameset cols="200,*" frameborder="0" border="0" framespacing="0">
	    ...
	    <frameset rows="30,*" frameborder="0" border="0" framespacing="0">
	        ...
	        <frame name="content" src="../Dashboard.aspx" marginheight="0" marginwidth="0" scrolling="auto" noresize>
        </frameset>
    </frameset>
</frameset>
</html>
