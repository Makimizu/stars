    ...
    public partial class Header : System.Web.UI.Page
    {
        ...
        protected void Setup()
        {
            ...
            try
            {
                ...
                IMG1.ImageUrl = GlobalUse.GetStringImageURLExt(conn, conn.QueryString, "PHOTO");
                IMG_LOGO.ImageUrl = GlobalUse.GetStringImageURLExt(conn, conn.QueryString, "LOGO");
