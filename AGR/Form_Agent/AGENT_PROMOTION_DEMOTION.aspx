<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AGENT_PROMOTION_DEMOTION.aspx.cs" Inherits="AGR.Form_Agent.AGENT_PROMOTION_DEMOTION" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="DV_MAIN" runat="server">
            ...
            <asp:DataGrid ID="DGR" runat="server" CellPadding="4" PageSize="20"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="SQL_LEVEL" Visible="False"></asp:BoundColumn>
                    <asp:BoundColumn DataField="LEVEL" Visible="False"></asp:BoundColumn>
                    <asp:BoundColumn DataField="LEVEL_DESCR" Visible="False"></asp:BoundColumn>
                                ...
                                <tr style="vertical-align: top;">
                                    ...
                                    <td>
                                        <table style="border-spacing: 0px; font-size: xx-small; width: 100%;">
                                            <tr>
                                                <td style="width: 80px; border-bottom: ridge;">REQUEST BY</td>
                                                <td style="border-bottom: ridge;">
                                                    <table style="border-spacing: 0px; width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right;">
                                                                <asp:Button ID="BT_REQ" runat="server" CssClass="ASPButton" Text="?" CommandName="Request" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td>LEVEL FROM</td>
                                                <td>
                                                    <asp:Label ID="LB_LEVELFROM" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>LEVEL TO</td>
        ...
        <div id="DV_TRANSFER" runat="server" visible="false">
            ...
            <table style="border-spacing: 0px; width: 100%; ">
                <tr>
                    <td class="TDBGColor">PROMOTION/DEMOTION REQUESTOR</td>
                </tr>
                <tr>
                    <td style="border-bottom: ridge;">
