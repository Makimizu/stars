<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AGENCY_CORPORATE_BRANCH.aspx.cs" Inherits="AGR.AGENCY_CORPORATE_BRANCH" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="border-spacing: 0px; width: 100%; font-size: xx-small;">
                ...
                <td>
                    <table style="border-spacing: 0px; font-size: x-small;">
                        ...
                        <tr>
                            <td>STATUS</td>
                            <td>
                                <asp:DropDownList ID="DDL_BRANCH_STATUS" Width="200px" runat="server" CssClass="ASPDropDownList">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="LB_LASTCHANGEBY" runat="server" Font-Bold="False" Font-Size="XX-Small" CssClass="ASPLabel"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>LAST CHANGED DATE</td>
                            <td>
                                <asp:Label ID="LB_LASTCHANGEDATE" runat="server" Font-Bold="False" Font-Size="XX-Small" CssClass="ASPLabel"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DGR_ACCOUNT" runat="server" CellPadding="4" ForeColor="#333333" OnItemCommand="DGR_ACCOUNT_ItemCommand" AutoGenerateColumns="False" Font-Size="XX-Small" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Width="95%" GridLines="None">
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DGR_KORESPONDEN" runat="server" CellPadding="4" ForeColor="#333333" OnItemCommand="DGR_ACCOUNT_ItemCommand" AutoGenerateColumns="False" GridLines="None" Font-Size="XX-Small" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Width="95%">
                        ...
                        <HeaderStyle BackColor="#1C5E55" Font-Bold="False" ForeColor="White" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" />
