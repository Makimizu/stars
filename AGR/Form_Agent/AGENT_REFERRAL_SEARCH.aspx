<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AGENT_REFERRAL_SEARCH.aspx.cs" Inherits="AGR.Form_Agent.AGENT_REFERRAL_SEARCH" %>
        ...
        <table style="border-spacing: 0px; font-size: x-small; font-family: Tahoma; width: 100%;">
            ...
            <tr>
                <td>
                    <table style="border-spacing: 0px; font-size: x-small; font-family: Tahoma; width: 100%;">
                        <tr>
                            <td style="width: 100px;">RECRUITER NAME</td>
                            <td>
