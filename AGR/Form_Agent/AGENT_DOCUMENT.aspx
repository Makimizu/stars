<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AGENT_DOCUMENT.aspx.cs" Inherits="AGR.AGENT_DOCUMENT" %>
                ...
                <td>
                    <asp:DataGrid ID="DGR_DOCS" runat="server" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="MANDATORY" Visible="False"></asp:BoundColumn>
                            <asp:TemplateColumn>
                                <ItemTemplate>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ItemTemplate>
                                    <asp:FileUpload ID="FU_DOC" runat="server" Width="200px" CssClass="ASPButton" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn>
                                <ItemStyle HorizontalAlign="Right" />
