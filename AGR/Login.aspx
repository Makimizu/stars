<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AGR.Login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="LB_MENUCODE" runat="server" Visible="false"></asp:Label>
        <asp:Label ID="Lbl_SysCode" runat="server" Visible="false"></asp:Label>
        <div class="container">
                    ...
                    <div class="login-html">
                        ...
                        <div class="login-form">
                            <div class="sign-in-htm">
                                ...
                                <div class="group hk-lnk" style="text-align: right; color: ghostwhite">
