    ...
    public partial class Parent : System.Web.UI.MasterPage
    {
        ...
        protected void Setup()
        {
            try
            {
                ...
                link.Attributes.Add("href", GlobalUse.GetStringImageURL(connsec.QueryString, "ICON", conn));
                Page.Header.Controls.Add(link);

                IMG_LOGO.ImageUrl = GlobalUse.GetStringImageURL(connsec.QueryString, "LOGO", conn);
            }
            catch { }
